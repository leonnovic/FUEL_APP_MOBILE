...
import { X, Crop, RotateCw, ZoomIn, ZoomOut, Check, RefreshCw, Sparkles } from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-black/90 z-50 flex flex-col">
      ...
      <div className="flex items-center justify-between p-3 bg-gray-900 border-b border-gray-700">
        <div className="flex items-center gap-2">
          ...
          {enhancedImage && (
            <span className="px-2 py-0.5 bg-green-600 text-white text-xs rounded">Enhanced</span>
          )}
        </div>
      ...
      <div className="flex items-center justify-center gap-2 p-3 bg-gray-900 border-t border-gray-700 flex-wrap">
        ...
        >
          ...
          {isEnhancing ? 'Enhancing...' : enhancedImage ? 'Enhanced' : 'Enhance'}
        </button>
        <button
