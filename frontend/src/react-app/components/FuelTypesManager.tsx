...
const DEFAULT_FUEL_TYPES: CustomFuelType[] = [
  { id: 'pms', code: 'PMS', name: 'Premium Motor Spirit', localName: 'Petrol', price: 220.30, costPrice: 190.00, taxRate: 16, levyRate: 0, color: 'red', icon: 'flame', pumpCount: 2, active: true, description: 'Standard petrol for vehicles' },
  { id: 'ago', code: 'AGO', name: 'Automotive Gas Oil', localName: 'Diesel', price: 250.01, costPrice: 189.50, taxRate: 16, levyRate: 0, color: 'blue', icon: 'droplet', pumpCount: 2, active: true, description: 'Standard diesel for vehicles' },
];
