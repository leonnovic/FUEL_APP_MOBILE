 ...
 * 5. Set VITE_GOOGLE_CLIENT_ID in environment
 */
 ...
 */
export async function exchangeGoogleCode(code: string): Promise<{ token: string; user: { id: string; email: string; name: string } }> {
