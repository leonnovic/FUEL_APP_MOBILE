  ...
  P = (function () {
    ...
    return (
      (e.setDefaults = function (t, r) {
        (r === void 0 && (r = null),
          r ? (r.__autoTableDocumentDefaults = t) : (B = t));
      }),
...
function $(e, t, r, i, n) {
  ...
  for (var v = 0; v < h.rows.length; v++) {
    var d = h.rows[v],
      m =
        (s =
          (a = d == null ? void 0 : d.parentElement) === null || a === void 0
            ? void 0
      ...
      for (var l = 0, g = {}, u = 0, v = 0, d = 0, m = r; d < m.length; d++) {
        ...
        if (s[p.index] == null || s[p.index].left === 0)
          if (v === 0) {
            ...
            typeof y == "object" &&
              !Array.isArray(y) &&
              (x = (y == null ? void 0 : y.styles) || {});
            var c = Rt(e, p, o, n, i, a, x),
              C = new Z(y, c, e);
            ((g[p.dataKey] = C),
              (g[p.index] = C),
              (v = C.colSpan - 1),
...
function Tt(e, t, r) {
  ...
  for (
    var o = !0,
      l = (i = r == null ? void 0 : r.start) !== null && i !== void 0 ? i : 0;
    l < t.columns.length;
  ) {
    if (a.has(l)) {
      l++;
  ...
  if (a.horizontalPageBreakBehaviour === "afterAllRows")
    n.forEach(function (o, l) {
      (e.applyStyles(e.userStyles),
        l > 0 ? H(e, t, r, i, o.columns, !0) : M(e, t, i, o.columns),
...
function Lt(e, t, r, i) {
  ...
  var d = new X(e.raw, -1, e.section, n, !0);
  d.height = a;
...
try {
  if (typeof window < "u" && window) {
    var O = window,
      Y =
        O.jsPDF || ((T = O.jspdf) === null || T === void 0 ? void 0 : T.jsPDF);
    Y && Ot(Y);
  }
} catch (e) {
