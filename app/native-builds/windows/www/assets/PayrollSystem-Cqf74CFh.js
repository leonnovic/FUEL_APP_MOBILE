...
import { E as va } from "./jspdf.es.min-Vx8DzP41.js";
import { a as _a } from "./jspdf.plugin.autotable-BTchFZcl.js";
import { F as Q } from "./file-spreadsheet-CTgoTu-6.js";
import { S as U } from "./square-pen-BM8mIb9F.js";
import { C as Te } from "./calculator-CExr6nLN.js";
function Ia() {
  const { user: m } = ua(),
    { state: O } = ga(),
    [_, X] = h.useState([]),
