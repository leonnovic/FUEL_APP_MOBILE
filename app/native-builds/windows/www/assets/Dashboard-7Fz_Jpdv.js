...
var bo = (s, t, e) =>
  t in s
    ? xo(s, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
    : (s[t] = e);
var P = (s, t, e) => bo(s, typeof t != "symbol" ? t + "" : t, e);
import { j as g } from "./trpc-DPYLJugK.js";
import {
  c as Xe,
  I as yn,
  z as Xs,
...
import { b as W } from "./vendor-ByIt1aj4.js";
import { I as Fo } from "./info-BBPzHWbf.js";
import { D as ys } from "./droplets-BLfzl5Vf.js";
import { A as Zs, a as Eo } from "./arrow-up-right-DbA7ADr0.js";
import { T as Bo } from "./trending-down-DxPsn4Ic.js";
/**
 ...
 */ const Xo = [
  ...
  Ko = Xe("wind", Xo),
  Go = { fuel_price: Te, tax: bs, compliance: Ks, license: bs, safety: Ks },
  qo = {
    high: "border-l-red-500 bg-red-500/5",
    medium: "border-l-amber-500 bg-amber-500/5",
    low: "border-l-blue-500 bg-blue-500/5",
  },
  Jo = { high: "High Priority", medium: "Medium", low: "Low" };
function Zo({ countryCode: s }) {
  const {
      regulatoryUpdates: t,
      markUpdateRead: e,
      dismissUpdate: i,
  ...
  return h.length === 0 && !r
    ? g.jsxs("div", {
        className:
          "flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800/50 rounded-lg px-3 py-2",
        children: [
          g.jsx(Xs, { size: 14, className: "text-green-500" }),
          g.jsx("span", { children: "All caught up! No pending alerts." }),
        ],
      })
    : g.jsxs("div", {
        className: "space-y-2",
            ...
            children: [
              g.jsxs("div", {
                ...
                children: [
                  ...
                  g.jsx("span", {
                    ...
                    children: "Regulatory Alerts",
                  }),
                  n > 0 &&
                    g.jsx("span", {
                      className: `text-[10px] px-1.5 py-0.5 rounded-full font-medium ${o > 0 ? "bg-red-500 text-white" : "bg-amber-500 text-white"}`,
                      children: n,
                    }),
                ],
              }),
              t.length > 3 &&
                g.jsx("button", {
                  ...
                  children: r ? "Show less" : `View all (${t.length})`,
                }),
            ],
          }),
          g.jsx("div", {
            className: "space-y-2",
            children: h.map(u => {
              const f = Go[u.category] || Fo;
              return g.jsx(
                "div",
                {
                  className: `relative border-l-2 ${qo[u.priority]} rounded-r-lg p-3 transition-all hover:bg-white/5 ${u.read ? "opacity-60" : ""}`,
                  children: g.jsxs("div", {
                    ...
                    children: [
                      g.jsxs("div", {
                        ...
                        children: [
                          g.jsx(f, {
                            size: 14,
                            className: `flex-shrink-0 mt-0.5 ${u.priority === "high" ? "text-red-400" : u.priority === "medium" ? "text-amber-400" : "text-blue-400"}`,
                          }),
                          g.jsxs("div", {
                            ...
                            children: [
                              g.jsxs("div", {
                                ...
                                children: [
                                  g.jsx("h5", {
                                    className:
                                      "text-xs font-semibold text-gray-800 dark:text-gray-200 truncate",
                                    children: u.title,
                                  }),
                                  g.jsx("span", {
                                    className: `text-[9px] px-1 rounded ${u.priority === "high" ? "bg-red-500/20 text-red-400" : u.priority === "medium" ? "bg-amber-500/20 text-amber-400" : "bg-blue-500/20 text-blue-400"}`,
                                    children: Jo[u.priority],
                                  }),
                                ],
                              }),
                              g.jsx("p", {
                                className:
                                  "text-[11px] text-gray-600 dark:text-gray-400 leading-relaxed",
                                children: u.summary,
                              }),
                              g.jsxs("div", {
                                ...
                                children: [
                                  g.jsxs("span", {
                                    className:
                                      "text-[9px] text-gray-500 dark:text-gray-500 flex items-center gap-1",
                                    children: [
                                      g.jsx(_o, { size: 8 }),
                                      new Date(
                                        u.effectiveDate
                                  ...
                                  g.jsxs("a", {
                                    ...
                                    className:
                                      "text-[9px] text-blue-500 hover:underline",
                                    children: ["Source: ", u.source],
                                  }),
                                ],
                              }),
                            ],
                        ...
                        children: [
                          !u.read &&
                            g.jsx("button", {
                              onClick: () => e(u.id),
                              className:
                                "p-1 rounded hover:bg-white/10 text-gray-400 hover:text-green-400 transition-colors",
                              title: "Mark as read",
                              children: g.jsx(Xs, { size: 12 }),
                            }),
                          g.jsx("button", {
                            onClick: () => d(u.id),
                            className:
                              "p-1 rounded hover:bg-white/10 text-gray-400 hover:text-red-400 transition-colors",
                            title: "Dismiss",
                            children: g.jsx(ko, { size: 12 }),
                          }),
                        ],
                      }),
                    ],
...
function Qo() {
  const { currentStation: s } = _n(),
    {
      preciseLocation: t,
      preciseLocationLoading: e,
      detectPreciseLocation: i,
    } = kn(),
    [n, o] = W.useState(null),
    [r, a] = W.useState(!0),
    [l, c] = W.useState(""),
    [h, d] = W.useState(null),
    [u, f] = W.useState(!1),
    p = W.useCallback(async (x, b, y) => {
      (a(!0), c(""));
      try {
        const k = `https://api.open-meteo.com/v1/forecast?latitude=${x}&longitude=${b}&current=temperature_2m,relative_humidity_2m,apparent_temperature,weather_code,wind_speed_10m,visibility&timezone=auto`,
          v = await fetch(k);
        if (!v.ok) throw new Error("Weather API error");
        const M = (await v.json()).current,
          w = M.weather_code;
        let S = "Clear",
          C = "Clear sky";
        (w === 0
          ? ((S = "Clear"), (C = "Clear sky"))
          : w >= 1 && w <= 3
            ? ((S = "Cloudy"), (C = "Partly cloudy"))
            : w >= 45 && w <= 48
              ? ((S = "Foggy"), (C = "Foggy conditions"))
              : w >= 51 && w <= 67
                ? ((S = "Rain"), (C = "Rainy conditions"))
                : w >= 71 && w <= 77
                  ? ((S = "Snow"), (C = "Snowfall"))
                  : w >= 80 && w <= 82
                    ? ((S = "Rain"), (C = "Heavy showers"))
                    : w >= 85 && w <= 86
                      ? ((S = "Snow"), (C = "Snow showers"))
                      : w >= 95 && ((S = "Storm"), (C = "Thunderstorm")),
          o({
            temp: M.temperature_2m,
            condition: S,
            description: C,
            humidity: M.relative_humidity_2m,
            windSpeed: M.wind_speed_10m,
            visibility: M.visibility / 1e3,
            icon: S,
            feelsLike: M.apparent_temperature,
            location: y,
            lat: x,
            lng: b,
          }),
        ...
        c("Failed to load weather");
      } finally {
        a(!1);
      }
    }, []);
  W.useEffect(() => {
    if (t) p(t.lat, t.lng, t.address);
    else if (!e) {
      const x =
        s != null && s.location
          ? { lat: -1.2921, lng: 36.8219, name: s.location }
          : { lat: -1.2921, lng: 36.8219, name: "Nairobi, Kenya" };
      p(x.lat, x.lng, x.name);
    }
  }, [t, e, s, p]);
  const m = () => {
    if (!n) return g.jsx(es, { size: 32, className: "text-amber-400" });
    switch (n.icon) {
      case "Clear":
        return g.jsx(es, { size: 32, className: "text-amber-400" });
      case "Cloudy":
        return g.jsx(Mo, { size: 32, className: "text-gray-400" });
      case "Rain":
        return g.jsx($o, { size: 32, className: "text-blue-400" });
      case "Snow":
        return g.jsx(Uo, { size: 32, className: "text-cyan-300" });
      case "Storm":
        return g.jsx(Wo, { size: 32, className: "text-purple-400" });
      default:
        return g.jsx(es, { size: 32, className: "text-amber-400" });
    }
  };
  return g.jsxs("div", {
    className:
      "bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl border border-blue-200 dark:border-blue-800 p-5",
    children: [
      g.jsxs("div", {
        ...
        children: [
          g.jsxs("h3", {
            className:
              "text-sm font-semibold text-blue-900 dark:text-blue-300 flex items-center gap-2",
            children: [
              g.jsx(Gs, { size: 15 }),
              u ? "Current Location Weather" : "Station Weather",
            ],
          }),
          g.jsxs("div", {
            className: "flex items-center gap-2",
            children: [
              u &&
                g.jsxs("span", {
                  className:
                    "flex items-center gap-1 text-[10px] bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 px-1.5 py-0.5 rounded",
                  children: [g.jsx(Gs, { size: 8 }), " Precise GPS"],
                }),
              g.jsx("button", {
                onClick: () => i(),
                className:
      ...
      r || e
        ? g.jsxs("div", {
            ...
            children: [
              g.jsx(wo, { size: 20, className: "text-blue-400 animate-spin" }),
              g.jsx("span", {
                className: "text-sm text-gray-500 ml-2",
                children: "Getting precise location...",
              }),
            ],
          })
        : l
          ? g.jsxs("div", {
              ...
              children: [
                g.jsx("p", { className: "text-sm text-red-400", children: l }),
                g.jsx("button", {
                  onClick: () => i(),
                  ...
                  g.jsx("div", {
                    ...
                    children: [
                      ...
                      },
                      {
                        icon: Ko,
                        label: "Wind",
                        value: `${n.windSpeed} km/h`,
                        color: "text-teal-500",
                      },
                      {
                        icon: So,
                        label: "Visibility",
                        value: `${n.visibility.toFixed(1)} km`,
                      ...
                      g.jsxs(
                        ...
                        {
                          className:
                            "bg-white/50 dark:bg-white/5 rounded-lg p-2.5 text-center",
                          children: [
                            g.jsx(x.icon, {
                              size: 16,
                              className: `mx-auto mb-1 ${x.color}`,
                            }),
                            g.jsx("p", {
...
const Pt = (s, t, e) => Math.max(Math.min(s, e), t);
function ee(s) {
  return Pt(be(s * 2.55), 0, 255);
}
function Ot(s) {
  return Pt(be(s * 255), 0, 255);
}
function vt(s) {
  return Pt(be(s / 2.55) / 100, 0, 1);
}
function Qs(s) {
  return Pt(be(s * 100), 0, 100);
}
const ht = {
    0: 0,
    1: 1,
  ...
  _s = [..."0123456789ABCDEF"],
  tr = s => _s[s & 15],
  er = s => _s[(s & 240) >> 4] + _s[s & 15],
  ye = s => (s & 240) >> 4 === (s & 15),
  sr = s => ye(s.r) && ye(s.g) && ye(s.b) && ye(s.a);
function ir(s) {
  var t = s.length,
    e;
  return (
      ...
      (t === 4 || t === 5
        ...
        : (t === 7 || t === 9) &&
          (e = {
            ...
            g: (ht[s[3]] << 4) | ht[s[4]],
            b: (ht[s[5]] << 4) | ht[s[6]],
            a: t === 9 ? (ht[s[7]] << 4) | ht[s[8]] : 255,
          })),
    e
  );
}
const nr = (s, t) => (s < 255 ? t(s) : "");
function or(s) {
  var t = sr(s) ? tr : er;
  return s ? "#" + t(s.r) + t(s.g) + t(s.b) + nr(s.a, t) : void 0;
}
const rr =
...
function Ts(s, t, e, i) {
  return (Array.isArray(t) ? s(t[0], t[1], t[2]) : s(t, e, i)).map(Ot);
}
function Ns(s, t, e) {
  return Ts(vn, s, t, e);
}
...
let _e;
function mr(s) {
  _e || ((_e = pr()), (_e.transparent = [0, 0, 0, 0]));
  const t = _e[s.toLowerCase()];
...
function br(s) {
  ...
  if (t) {
    if (t[7] !== i) {
      const r = +t[7];
      e = t[8] ? ee(r) : Pt(r * 255, 0, 255);
    }
    return (
      (i = +t[1]),
      (n = +t[3]),
      (o = +t[5]),
      (i = 255 & (t[2] ? ee(i) : Pt(i, 0, 255))),
      (n = 255 & (t[4] ? ee(n) : Pt(n, 0, 255))),
      (o = 255 & (t[6] ? ee(o) : Pt(o, 0, 255))),
      { r: i, g: n, b: o, a: e }
    );
  }
}
...
const ns = s =>
  ...
  Vt = s => (s <= 0.04045 ? s / 12.92 : Math.pow((s + 0.055) / 1.055, 2.4));
function _r(s, t, e) {
  const i = Vt(vt(s.r)),
    n = Vt(vt(s.g)),
    o = Vt(vt(s.b));
  return {
    r: Ot(ns(i + e * (Vt(vt(t.r)) - i))),
    g: Ot(ns(n + e * (Vt(vt(t.g)) - n))),
    b: Ot(ns(o + e * (Vt(vt(t.b)) - o))),
    a: s.a + e * (t.a - s.a),
  };
}
function ke(s, t, e) {
  ...
  return (
    Array.isArray(s)
      ? s.length >= 3 &&
        ...
        s.length > 3 && (t.a = Ot(s[3])))
      : ((t = Sn(s, { r: 0, g: 0, b: 0, a: 1 })), (t.a = Ot(t.a))),
    t
  );
}
function kr(s) {
  return s.charAt(0) === "r" ? br(s) : ur(s);
}
class he {
  constructor(t) {
...
function B(s, t, e, i) {
  let n, o, r;
  if (X(s)) for (o = s.length, n = 0; n < o; n++) t.call(e, s[n], n);
  else if (z(s))
...
function Be(s) {
  if (X(s)) return s.map(Be);
  if (z(s)) {
    const t = Object.create(null),
      e = Object.keys(s),
      i = e.length;
    let n = 0;
    for (; n < i; ++n) t[e[n]] = Be(s[e[n]]);
    return t;
  }
  return s;
}
...
function Mr(s, t, e) {
  ...
  z(i) && z(n)
    ? re(i, n)
    : Object.prototype.hasOwnProperty.call(t, s) || (t[s] = Be(n));
}
const ii = { "": s => s, x: s => s.x, y: s => s.y };
function Pr(s) {
  const t = s.split("."),
    e = [];
  let i = "";
...
function Bt(s, t) {
  return (ii[t] || (ii[t] = Cr(t)))(s);
}
function Rs(s) {
  return s.charAt(0).toUpperCase() + s.slice(1);
}
const ue = s => typeof s < "u",
  At = s => typeof s == "function",
  ni = (s, t) => {
...
function ri(s) {
  ...
  s = ae(s, t, s / 1e3) ? t : s;
  const e = Math.pow(10, Math.floor(Cn(s))),
    i = s / e;
...
function fe(s) {
  return !Tr(s) && !isNaN(parseFloat(s)) && isFinite(s);
}
function Nr(s, t) {
...
function Dn(s, t) {
  ...
  return (o < -0.5 * H && (o += $), { angle: o, distance: n });
}
function ks(s, t) {
...
function Ir(s) {
  return Z(s, -32768, 32767);
}
function St(s, t, e, i = 1e-6) {
...
const zs = s => (s === "start" ? "left" : s === "end" ? "right" : "center"),
  J = (s, t, e) => (s === "start" ? t : s === "end" ? e : (t + e) / 2),
  Wr = (s, t, e, i) =>
...
function Vr(s, t, e) {
  ...
  if (s._sorted) {
    const { iScale: r, vScale: a, _parsed: l } = s,
      ...
      h = r.axis,
      { min: d, max: u, minDefined: f, maxDefined: p } = r.getUserBounds();
    if (f) {
      if (
        ((n = Math.min(
          It(l, h, d).lo,
          e ? i : It(t, h, r.getPixelForValue(d)).lo
        )),
        c)
      ) {
        const m = l
    ...
    if (p) {
      let m = Math.max(
        It(l, r.axis, u, !0).hi + 1,
        e ? 0 : It(t, h, r.getPixelForValue(u), !0).hi + 1
      );
      if (c) {
        const x = l.slice(m - 1).findIndex(b => !E(b[a.axis]));
        m += Math.max(0, x);
      }
      o = Z(m, n, i) - n;
    } else o = i - n;
...
const ve = s => s === 0 || s === 1,
  ci = (s, t, e) => -(Math.pow(2, 10 * (s -= 1)) * Math.sin(((s - t) * $) / e)),
  hi = (s, t, e) => Math.pow(2, -10 * s) * Math.sin(((s - t) * $) / e) + 1,
  le = {
    linear: s => s,
    easeInQuad: s => s * s,
    easeOutQuad: s => -s * (s - 2),
    ...
    easeInOutSine: s => -0.5 * (Math.cos(H * s) - 1),
    ...
    easeInElastic: s => (ve(s) ? s : ci(s, 0.075, 0.3)),
    easeOutElastic: s => (ve(s) ? s : hi(s, 0.075, 0.3)),
    easeInOutElastic(s) {
      return ve(s)
        ? s
        : s < 0.5
          ? 0.5 * ci(s * 2, 0.1125, 0.45)
          : 0.5 + 0.5 * hi(s * 2 - 1, 0.1125, 0.45);
    },
    easeInBack(s) {
    ...
    easeInBounce: s => 1 - le.easeOutBounce(1 - s),
    easeOutBounce(s) {
      return s < 1 / 2.75
        ? 7.5625 * s * s
        : s < 2 / 2.75
    ...
    easeInOutBounce: s =>
      s < 0.5
        ? le.easeInBounce(s * 2) * 0.5
        : le.easeOutBounce(s * 2 - 1) * 0.5 + 0.5,
  };
function Is(s) {
...
function di(s) {
  return Is(s) ? s : new he(s);
}
function os(s) {
  return Is(s) ? s : new he(s).saturate(0.5).darken(0.1).hexString();
}
const Yr = ["x", "y", "borderWidth", "radius", "tension"],
  Ur = ["color", "borderColor", "backgroundColor"];
function Xr(s) {
  (s.set("animation", {
    delay: void 0,
    duration: 1e3,
    ...
    s.set("animations", {
      colors: { type: "color", properties: Ur },
      numbers: { type: "number", properties: Yr },
    }),
...
function Gr(s, t) {
  ...
  let i = ui.get(e);
  return (i || ((i = new Intl.NumberFormat(s, t)), ui.set(e, i)), i);
}
function Fs(s, t, e) {
  return Gr(t, e).format(s);
}
const qr = {
  values(s) {
    return X(s) ? s : "" + s;
  ...
  numeric(s, t, e) {
    ...
    if (e.length > 1) {
      ...
      ((c < 1e-4 || c > 1e15) && (n = "scientific"), (o = Jr(s, e)));
    }
    const r = Cn(Math.abs(o)),
      a = isNaN(r) ? 1 : Math.max(Math.min(-1 * Math.floor(r), 20), 0),
      l = { notation: n, minimumFractionDigits: a, maximumFractionDigits: a };
    return (Object.assign(l, this.options.ticks.format), Fs(s, i, l));
  },
};
function Jr(s, t) {
...
function rs(s, t, e) {
  return typeof t == "string" ? de(ce(s, t), e) : de(ce(s, ""), t);
}
class Qr {
  constructor(t, e) {
    ((this.animation = void 0),
      ...
      (this.hover = {}),
      (this.hoverBackgroundColor = (i, n) => os(n.backgroundColor)),
      (this.hoverBorderColor = (i, n) => os(n.borderColor)),
      (this.hoverColor = (i, n) => os(n.color)),
      (this.indexAxis = "x"),
      (this.interaction = {
        mode: "nearest",
        intersect: !0,
    ...
    Object.defineProperties(o, {
      ...
      [e]: {
        ...
        get() {
          const l = this[a],
            c = r[n];
          return z(l) ? Object.assign({}, c, l) : T(l, c);
        },
        set(l) {
          this[a] = l;
        },
...
function Rn(s, t, e, i, n) {
  ...
  if (!(isNaN(m) || m <= 0)) {
    switch ((s.beginPath(), f)) {
      ...
      case "triangle":
        ((h = n ? n / 2 : m),
          s.moveTo(e + Math.sin(x) * h, i - Math.cos(x) * m),
          (x += oi),
          s.lineTo(e + Math.sin(x) * h, i - Math.cos(x) * m),
          (x += oi),
          s.lineTo(e + Math.sin(x) * h, i - Math.cos(x) * m),
          s.closePath());
        break;
      case "rectRounded":
        ((c = m * 0.516),
          (l = m - c),
          (r = Math.cos(x + Tt) * l),
          (d = Math.cos(x + Tt) * (n ? n / 2 - c : l)),
          (a = Math.sin(x + Tt) * l),
          (u = Math.sin(x + Tt) * (n ? n / 2 - c : l)),
          s.arc(e - d, i - a, c, x - H, x - q),
          s.arc(e + u, i - r, c, x - q, x),
          s.arc(e + d, i + a, c, x, x + q),
          s.arc(e - u, i + r, c, x + q, x + H),
          s.closePath());
        break;
      case "rect":
        if (!p) {
        ...
        x += Tt;
      case "rectRot":
        ((d = Math.cos(x) * (n ? n / 2 : m)),
          (r = Math.cos(x) * m),
          (a = Math.sin(x) * m),
          (u = Math.sin(x) * (n ? n / 2 : m)),
          s.moveTo(e - d, i - a),
          s.lineTo(e + u, i - r),
          s.lineTo(e + d, i + a),
          s.lineTo(e - u, i + r),
      ...
      case "dash":
        (s.moveTo(e, i),
          s.lineTo(e + Math.cos(x) * (n ? n / 2 : m), i + Math.sin(x) * m));
        break;
      case !1:
        s.closePath();
        break;
...
function me(s, t, e, i, n, o = {}) {
  const r = X(t) ? t : [t],
    a = o.strokeWidth > 0 && o.strokeColor !== "";
  let l, c;
  for (s.save(), s.font = n.string, ia(s, o), l = 0; l < r.length; ++l)
    ((c = r[l]),
      o.backdrop && oa(s, o.backdrop),
      a &&
        (o.strokeColor && (s.strokeStyle = o.strokeColor),
        E(o.strokeWidth) || (s.lineWidth = o.strokeWidth),
...
function We(s, t) {
  ...
  (s.arc(e + r.topLeft, i + r.topLeft, r.topLeft, 1.5 * H, H, !0),
    s.lineTo(e, i + o - r.bottomLeft),
    s.arc(e + r.bottomLeft, i + o - r.bottomLeft, r.bottomLeft, H, q, !0),
...
const ra = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/,
  aa = /^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/;
function la(s, t) {
  const e = ("" + s).match(ra);
...
function Es(s, t) {
  const e = {},
    i = z(t),
    n = i ? Object.keys(t) : t,
    o = z(s) ? (i ? r => T(s[r], s[t[r]]) : r => s[r]) : () => s;
  for (const r of n) e[r] = ca(o(r));
  return e;
}
function Ln(s) {
  return Es(s, { top: "y", right: "x", bottom: "y", left: "x" });
}
function Yt(s) {
  return Es(s, ["topLeft", "topRight", "bottomLeft", "bottomRight"]);
}
function ut(s) {
  const t = Ln(s);
...
function Q(s, t) {
  ((s = s || {}), (t = t || U.font));
  let e = T(s.size, t.size);
  typeof e == "string" && (e = parseInt(e, 10));
  let i = T(s.style, t.style);
  i &&
    !("" + i).match(aa) &&
    (console.warn('Invalid font style specified: "' + i + '"'), (i = void 0));
  const n = {
    family: T(s.family, t.family),
    lineHeight: la(T(s.lineHeight, t.lineHeight), e),
    size: e,
    style: i,
    weight: T(s.weight, t.weight),
    string: "",
  };
...
function Bs(s, t = [""], e, i, n = () => s[0]) {
  const o = e || s;
  typeof i > "u" && (i = En("_fallback", s));
  const r = {
...
function Xt(s, t, e, i) {
  const n = {
    ...
    _stack: new Set(),
    _descriptors: zn(s, i),
    setContext: o => Xt(s, o, e, i),
    override: o => Xt(s.override(o), t, e, i),
  };
  return new Proxy(n, {
    deleteProperty(o, r) {
...
function zn(s, t = { scriptable: !0, indexable: !0 }) {
  const {
...
function ua(s, t, e) {
  ...
  let a = i[t];
  return (
    At(a) && r.isScriptable(t) && (a = fa(t, a, s, e)),
    X(a) && a.length && (a = ga(t, a, s, r.isIndexable)),
    Hs(t, a) && (a = Xt(a, n, o && o[t], r)),
    a
  );
}
function fa(s, t, e, i) {
  ...
  a.add(s);
  let l = t(o, r || i);
  return (a.delete(s), Hs(s, l) && (l = Ws(n._scopes, n, s, l)), l);
}
function ga(s, t, e, i) {
...
const pa = (s, t) => (s === !0 ? t : typeof s == "string" ? Bt(t, s) : void 0);
...
function Ws(s, t, e, i) {
  const n = t._rootScopes,
    o = Fn(t._fallback, e, i),
    r = [...s, ...n],
    a = new Set();
  a.add(i);
  let l = pi(a, r, e, o || e, i);
  return l === null ||
    (typeof o < "u" && o !== e && ((l = pi(a, r, o, l, i)), l === null))
    ? !1
    : Bs(Array.from(a), [""], n, o, () => xa(t, e, i));
}
function pi(s, t, e, i, n) {
  for (; e; ) e = ma(s, t, e, i, n);
  return e;
}
function xa(s, t, e) {
...
function ba(s, t, e, i) {
  let n;
  for (const o of t)
    if (((n = En(da(o, s), e)), typeof n < "u"))
      return Hs(s, n) ? Ws(e, i, s, n) : n;
}
function En(s, t) {
  for (const e of t) {
    if (!e) continue;
...
function mi(s) {
  let t = s._keys;
  return (t || (t = s._keys = ya(s._scopes)), t);
}
function ya(s) {
  const t = new Set();
  for (const e of s)
...
function wa(s, t, e = "x") {
  ...
  let o,
    ...
    l = Kt(s, 0);
  for (let c = 0; c < n; ++c) {
    if (((r = a), (a = l), (l = Kt(s, c + 1)), !a)) continue;
    const h = a[e],
      d = a[i];
    (r &&
      ((o = (h - r[e]) / 3),
  ...
  for (e = 0, i = s.length; e < i; ++e)
    ((r = o),
      ...
      o &&
        ((n = s[e]),
        r &&
          ((n.cp1x = Se(n.cp1x, t.left, t.right)),
          (n.cp1y = Se(n.cp1y, t.top, t.bottom))),
        a &&
          ((n.cp2x = Se(n.cp2x, t.left, t.right)),
          (n.cp2y = Se(n.cp2y, t.top, t.bottom)))));
}
function Pa(s, t, e, i, n) {
  ...
  if (
    ...
    for (o = 0, r = s.length; o < r; ++o)
      ((a = s[o]),
        (l = ka(c, a, s[Math.min(o + 1, r - (i ? 0 : 1)) % r], t.tension)),
        (a.cp1x = l.previous.x),
        (a.cp1y = l.previous.y),
        (a.cp2x = l.next.x),
        (a.cp2y = l.next.y),
...
const qe = s => s.ownerDocument.defaultView.getComputedStyle(s, null);
function Ca(s, t) {
  return qe(s).getPropertyValue(t);
}
...
const ja = (s, t, e) => (s > 0 || t > 0) && (!e || !e.shadowRoot);
function Oa(s, t) {
  const e = s.touches,
    i = e && e.length ? e[0] : s,
  ...
  if (t === void 0 || e === void 0) {
    ...
    if (!o) ((t = s.clientWidth), (e = s.clientHeight));
      ...
      ((t = r.width - c.width - l.width),
        ...
        (i = Ve(a.maxWidth, o, "clientWidth")),
        (n = Ve(a.maxHeight, o, "clientHeight")));
    }
  }
  return { width: t, height: e, maxWidth: i || He, maxHeight: n || He };
}
const Ct = s => Math.round(s * 10) / 10;
function Ta(s, t, e, i) {
  const n = qe(s),
    o = Ft(n, "margin"),
    r = Ve(n.maxWidth, s, "clientWidth") || He,
    a = Ve(n.maxHeight, s, "clientHeight") || He,
    l = Aa(s, t, e);
  ...
  return (
    ...
    (t !== void 0 || e !== void 0) &&
      ...
      l.height &&
      h > l.height &&
      ((h = l.height), (c = Ct(Math.floor(h * i)))),
    { width: c, height: h }
  );
}
function xi(s, t, e) {
  const i = t || 1,
    n = Ct(s.height * i),
    o = Ct(s.width * i);
  ((s.height = Ct(s.height)), (s.width = Ct(s.width)));
  const r = s.canvas;
  return (
    r.style &&
...
function Vn(s) {
  return s === "angle"
    ? { between: ge, compare: zr, normalize: lt }
    : { between: St, compare: (t, e) => t - e, normalize: t => t };
}
function yi({ start: s, end: t, count: e, loop: i, style: n }) {
  return {
    start: s % e,
    end: t % e,
    loop: i && (t - s + 1) % e === 0,
...
function Fa(s, t, e) {
  const { property: i, start: n, end: o } = e,
    { between: r, normalize: a } = Vn(i),
    l = t.length;
  let { start: c, end: h, loop: d } = s,
    u,
    f;
  if (d) {
    for (c += l, h += l, u = 0, f = l; u < f && r(a(t[c % l][i]), n, o); ++u)
      (c--, h--);
    ((c %= l), (h %= l));
  }
...
function $n(s, t, e) {
  ...
  const { property: i, start: n, end: o } = e,
    r = t.length,
    { compare: a, between: l, normalize: c } = Vn(i),
    { start: h, end: d, loop: u, style: f } = Fa(s, t, e),
    p = [];
  let m = !1,
    x = null,
    b,
    y,
    k;
  const v = () => l(n, k, b) && a(n, k) !== 0,
    _ = () => a(o, b) === 0 || l(o, k, b),
    M = () => m || v(),
    w = () => !m || _();
  for (let S = h, C = h; S <= d; ++S)
    ((y = t[S % r]),
      !y.skip &&
        ((b = c(y[i])),
        b !== k &&
          ((m = l(b, n, o)),
          x === null && M() && (x = a(b, n) === 0 ? S : C),
          x !== null &&
            w() &&
            (p.push(yi({ start: x, end: S, loop: u, count: r, style: f })),
            (x = null)),
          (C = S),
          (k = b))));
  return (
    x !== null && p.push(yi({ start: x, end: d, loop: u, count: r, style: f })),
    p
  );
}
function Yn(s, t) {
...
function Ha(s, t) {
  ...
  if (!n) return [];
  const o = !!s._loop,
    { start: r, end: a } = Ea(e, n, o, i);
  if (i === !0) return _i(s, [{ start: r, end: a, loop: o }], e, t);
  const l = a < r ? a + n : a,
    c = !!s._fullLoop && r === 0 && a === n - 1;
  return _i(s, Ba(e, r, l, c), e, t);
}
function _i(s, t, e, i) {
  return !i || !i.setContext || !e ? t : Wa(s, t, e, i);
}
function Wa(s, t, e, i) {
  ...
  function f(p, m, x, b) {
    ...
    if (p !== m) {
      ...
      for (; e[m % l].skip; ) m += y;
      p % l !== m % l &&
        (c.push({ start: p % l, end: m % l, loop: x, style: b }),
        (h = b),
        (d = m % l));
    }
  }
...
function Va(s, t) {
  ...
  const e = [],
    i = function (n, o) {
      return Is(o) ? (e.includes(o) || e.push(o), e.indexOf(o)) : o;
    };
...
class Xa {
  constructor(t, e, i, n) {
    ...
    const r = we([t.from, o, n]);
    ((this._active = !0),
      (this._fn = t.fn || Ua[t.type || typeof r]),
      (this._easing = le[t.easing] || le.linear),
...
class Xn {
  ...
  _animateOptions(t, e) {
    ...
    return (
      i.$shared &&
        Ka(t.options.$animations, i).then(
          () => {
            t.options = i;
          },
          () => {}
...
function Si(s, t, e, i = {}) {
  ...
  for (r = 0, a = n.length; r < a; ++r) {
    ...
    ((c = s.values[l]), tt(c) && (o || t === 0 || bt(t) === bt(c)) && (t += c));
  }
  return !h && !i.all ? 0 : t;
}
function Za(s, t) {
...
function Pi(s, t) {
  ...
  for (let f = 0; f < d; ++f) {
    ...
    ((u = b[c] = el(n, h, m)),
      (u[a] = x),
      (u._top = Mi(u, r, !0, i.type)),
      (u._bottom = Mi(u, r, !1, i.type)));
...
const cs = s => s === "reset" || s === "none",
  Ci = (s, t) => (t ? s : Object.assign({}, s)),
  nl = (s, t, e) =>
    s && !t.hidden && t._stacked && { keys: Kn(e, !0), values: null };
class Et {
  constructor(t, e) {
    ((this.chart = t),
      (this._ctx = t.ctx),
  ...
  linkScales() {
    const t = this.chart,
      ...
      o = (e.xAxisID = T(i.xAxisID, ls(t, "x"))),
      r = (e.yAxisID = T(i.yAxisID, ls(t, "y"))),
      a = (e.rAxisID = T(i.rAxisID, ls(t, "r"))),
      l = e.indexAxis,
  ...
  _destroy() {
    const t = this._cachedMeta;
    (this._data && li(this._data, this), t._stacked && qt(t));
  }
  _dataCheck() {
    ...
    if (z(e)) {
      ...
      (e && Object.isExtensible(e) && Br(e, this),
        (this._syncList = []),
        (this._data = e));
    }
  }
  ...
  buildOrUpdateElements(t) {
    ...
    ((e._stacked = as(e.vScale, e)),
      e.stack !== i.stack && ((n = !0), qt(e), (e.stack = i.stack)),
      this._resyncElements(t),
      (n || o !== e._stacked) &&
        (Pi(this, e._parsed), (e._stacked = as(e.vScale, e))));
  }
  configure() {
  ...
  parseObjectData(t, e, i, n) {
    ...
    for (h = 0, d = n; h < d; ++h)
      ((u = h + i),
        (f = e[u]),
        (c[h] = { x: o.parse(Bt(f, a), u), y: r.parse(Bt(f, l), u) }));
    return c;
  }
  getParsed(t) {
  ...
  applyStack(t, e, i) {
    const n = this.chart,
      o = this._cachedMeta,
      r = e[t.axis],
      a = { keys: Kn(n, !0), values: e._stacks[t.axis]._visualValues };
    return Si(a, r, o.index, { mode: i });
  }
  updateRangeFromParsed(t, e, i, n) {
    const o = i[e.axis];
    let r = o === null ? NaN : o;
    const a = n && i._stacks[e.axis];
    (n && a && ((n.values = a), (r = Si(n, o, this._cachedMeta.index))),
  ...
  getContext(t, e, i) {
    ...
    if (t >= 0 && t < this._cachedMeta.data.length) {
      ...
      ((o = r.$context || (r.$context = il(this.getContext(), t, r))),
      ...
      ((o =
        this.$context ||
        (this.$context = sl(this.chart.getContext(), this.index))),
        (o.dataset = n),
  ...
  _resolveElementOptions(t, e = "default", i) {
    const n = e === "active",
      ...
      r = t + "-" + e,
      a = o[r],
      l = this.enableOptionSharing && ue(i);
    if (a) return Ci(a, l);
    const c = this.chart.config,
      ...
      m = c.resolveNamedOptions(u, f, p, d);
    return (
      m.$shared && ((m.$shared = l), (o[r] = Object.freeze(Ci(m, l)))),
      m
    );
  }
  ...
  updateElement(t, e, i, n) {
    cs(n) ? Object.assign(t, i) : this._resolveAnimations(e, n).update(t, i);
  }
...
(P(Et, "defaults", {}),
  P(Et, "datasetElementType", null),
  P(Et, "dataElementType", null));
function ol(s, t) {
  if (!s._cache.$bar) {
    ...
    s._cache.$bar = On(i.sort((n, o) => n - o));
  }
  return s._cache.$bar;
}
function rl(s) {
  ...
  const l = () => {
    r === 32767 ||
      r === -32768 ||
      (ue(a) && (i = Math.min(i, Math.abs(r - a) || i)), (a = r));
  };
...
function Gn(s, t, e, i) {
  return (X(s) ? cl(s, t, e, i) : (t[e.axis] = e.parse(s, i)), t);
}
function Di(s, t, e, i) {
  const n = s.iScale,
    o = s.vScale,
...
function hl(s, t, e) {
  return s !== 0 ? bt(s) : (t.isHorizontal() ? 1 : -1) * (t.min >= e ? 1 : -1);
}
function dl(s) {
  let t, e, i, n, o;
  return (
...
function ul(s, t, e, i) {
  ...
  const { start: r, end: a, reverse: l, top: c, bottom: h } = dl(s);
  (n === "middle" &&
    e &&
...
function ji(s, t, e, i) {
  return (i ? ((s = fl(s, t, e)), (s = Oi(s, e, t))) : (s = Oi(s, t, e)), s);
}
function fl(s, t, e) {
...
function gl(s, { inflateAmount: t }, e) {
...
class Ne extends Et {
  ...
  parseObjectData(t, e, i, n) {
    ...
    for (u = i, f = i + n; u < f; ++u)
      ((m = e[u]),
        (p = {}),
        (p[o.axis] = o.parse(Bt(m, c), u)),
        d.push(Gn(Bt(m, h), p, r, u)));
    return d;
  }
  updateRangeFromParsed(t, e, i, n) {
    ...
    for (let f = e; f < e + i; f++) {
      const p = this.getParsed(f),
        ...
        y = {
          ...
          base: m.base,
          enableBorderRadius:
            !b || hs(p._custom) || r === b._top || r === b._bottom,
          x: c ? m.head : x.center,
          y: c ? x.center : m.head,
          height: c ? x.size : Math.abs(m.size),
          width: c ? Math.abs(m.size) : x.size,
        };
      u &&
        (y.options =
          d || this.resolveDataElementOptions(f, t[f].active ? "active" : n));
      const k = y.options || t[f].options;
      (ul(y, k, b, r), gl(y, k, h.ratio), this.updateElement(t[f], f, y, n));
    }
  }
  _getStacks(t, e) {
  ...
  _getAxis() {
    ...
    for (const i of this.chart.data.datasets)
      t[T(this.chart.options.indexAxis === "x" ? i.xAxisID : i.yAxisID, e)] =
        !0;
    return Object.keys(t);
  }
  ...
  _calculateBarValuePixels(t) {
    ...
    if (
      ...
      ((m = hl(m, e, a) * r), d === a && (b -= m / 2));
      const y = e.getPixelForDecimal(0),
        k = e.getPixelForDecimal(1),
        v = Math.min(y, k),
        _ = Math.max(y, k);
    ...
    if (b === e.getPixelForValue(a)) {
      const y = (bt(m) * e.getLineWidthForValue(a)) / 2;
      ((b += y), (m -= y));
    }
  ...
  _calculateBarIndexPixels(t, e) {
    const i = e.scale,
      n = this.options,
      o = n.skipNull,
      r = T(n.maxBarThickness, 1 / 0);
    let a, l;
    const c = this._getAxisCount();
    if (e.grouped) {
      const h = o ? this._getStackCount(t) : e.stackCount,
        d = n.barThickness === "flex" ? ll(t, e, n, h * c) : al(t, e, n, h * c),
        u =
...
function pl(s, t, e) {
  ...
  if (t < $) {
    const a = s,
      ...
      d = Math.cos(l),
      u = Math.sin(l),
      f = (k, v, _) => (ge(k, a, l, !0) ? 1 : Math.max(v, v * e, _, _ * e)),
      p = (k, v, _) => (ge(k, a, l, !0) ? -1 : Math.min(v, v * e, _, _ * e)),
      m = f(0, c, d),
      x = f(q, h, u),
      b = p(H, c, d),
      y = p(H + q, h, u);
...
class se extends Et {
  ...
  update(t) {
    const e = this.chart,
      ...
      l = Math.min(wr(this.options.cutout, a), 1),
      c = this._getRingWeight(this.index),
      { circumference: h, rotation: d } = this._getRotationExtents(),
      { ratioX: u, ratioY: f, offsetX: p, offsetY: m } = pl(d, h, l),
      x = (i.width - r) / u,
      b = (i.height - r) / f,
      y = Math.max(Math.min(x, b) / 2, 0),
      k = Mn(this.options.radius, y),
      v = Math.max(k * l, 0),
      _ = (k - v) / this._getVisibleDatasetWeightTotal();
    ((this.offsetX = p * k),
      (this.offsetY = m * k),
      (n.total = this.calculateTotal()),
      (this.outerRadius = k - _ * this._getRingWeightOffset(this.index)),
  ...
  updateElements(t, e, i, n) {
    const o = n === "reset",
      ...
      { sharedOptions: m, includeOptions: x } = this._getSharedOptions(e, n);
    let b = this._getRotation(),
      y;
    for (y = 0; y < e; ++y) b += this._circumference(y, o);
    for (y = e; y < e + i; ++y) {
      const k = this._circumference(y, o),
        v = t[y],
        _ = {
          x: h + this.offsetX,
          y: d + this.offsetY,
      ...
      (x &&
        (_.options =
          m || this.resolveDataElementOptions(y, v.active ? "active" : n)),
        (b += k),
        this.updateElement(v, y, _, n));
    }
  }
  calculateTotal() {
    const t = this._cachedMeta,
  ...
  getLabelAndValue(t) {
    const e = this._cachedMeta,
      i = this.chart,
      n = i.data.labels || [],
      o = Fs(e._parsed[t], i.options.locale);
...
class Re extends Et {
  ...
  updateElements(t, e, i, n) {
    const o = n === "reset",
      ...
      x = fe(p) ? p : Number.POSITIVE_INFINITY,
    ...
    for (let _ = 0; _ < k; ++_) {
      ...
      const S = this.getParsed(_),
        C = E(S[f]),
        N = (w[u] = r.getPixelForValue(S[u], _)),
        O = (w[f] =
          o || C
            ? a.getBasePixel()
            : a.getPixelForValue(l ? this.applyStack(a, S, l) : S[f], _));
      ((w.skip = isNaN(N) || isNaN(O) || C),
        (w.stop = _ > 0 && Math.abs(S[u] - v[u]) > x),
        m && ((w.parsed = S), (w.raw = c.data[_])),
        d &&
          (w.options =
            h || this.resolveDataElementOptions(_, M.active ? "active" : n)),
        b || this.updateElement(M, _, w, n),
        (v = S));
    }
  }
  getMaxOverflow() {
...
function xl(s, t, e, i) {
  ...
  if (a && t === a.axis && t !== "r" && r && o.length) {
    const c = a._reversePixels ? Fr : It;
    if (i) {
      if (n._sharedOptions) {
        const h = o[0],
      ...
      if (l) {
        const { vScale: d } = n._cachedMeta,
          ...
          f = u
            .slice(0, h.lo + 1)
            .reverse()
            .findIndex(m => !E(m[d.axis]));
        h.lo -= Math.max(0, f);
        const p = u.slice(h.hi).findIndex(m => !E(m[d.axis]));
        h.hi += Math.max(0, p);
      }
      return h;
    }
...
function yl(s, t, e, i) {
  ...
  function o(r, a, l) {
    const { startAngle: c, endAngle: h } = r.getProps(
      ...
      { angle: d } = Dn(r, { x: t.x, y: t.y });
    ge(d, c, h) && n.push({ element: r, datasetIndex: a, index: l });
  }
  return (Je(s, e, t, o), n);
}
function _l(s, t, e, i, n, o) {
  ...
  function c(h, d, u) {
    ...
    if (!(!!o || s.isPointInArea(p)) && !f) return;
    const x = a(t, p);
    x < l
      ? ((r = [{ element: h, datasetIndex: d, index: u }]), (l = x))
      : x === l && r.push({ element: h, datasetIndex: d, index: u });
  }
  return (Je(s, e, t, c), r);
}
  ...
  modes: {
    index(s, t, e, i) {
      const n = Lt(t, s),
        ...
        a = e.intersect ? ds(s, n, o, i, r) : us(s, n, o, !1, i, r),
        l = [];
      return a.length
    ...
    dataset(s, t, e, i) {
      const n = Lt(t, s),
        o = e.axis || "xy",
        r = e.includeInvisible || !1;
      let a = e.intersect ? ds(s, n, o, i, r) : us(s, n, o, !1, i, r);
      if (a.length > 0) {
    ...
    nearest(s, t, e, i) {
      const n = Lt(t, s),
        o = e.axis || "xy",
        r = e.includeInvisible || !1;
      return us(s, n, o, e.intersect, i, r);
    },
    x(s, t, e, i) {
      const n = Lt(t, s);
      return Ai(s, n, "x", e.intersect, i);
    },
    y(s, t, e, i) {
      const n = Lt(t, s);
      return Ai(s, n, "y", e.intersect, i);
    },
  },
};
...
function Ti(s, t) {
  return s.filter(e => qn.indexOf(e.pos) === -1 && e.box.axis === t);
}
function Zt(s, t) {
  return s.sort((e, i) => {
    const n = t ? i : e,
...
function Pl(s, t, e, i) {
  ...
  const a = Math.max(0, t.outerWidth - Ni(r, s, "left", "right")),
    l = Math.max(0, t.outerHeight - Ni(r, s, "top", "bottom")),
    c = a !== s.w,
    h = l !== s.h;
  return (
    (s.w = a),
...
function ie(s, t, e, i) {
  ...
  for (o = 0, r = s.length, c = 0; o < r; ++o) {
    ((a = s[o]),
      (l = a.box),
      l.update(a.width || t.w, a.height || t.h, Dl(a.horizontal, t)));
    const { same: d, other: u } = Pl(t, e, a, i);
    ((c |= d && n.length), (h = h || u), l.fullSize || n.push(a));
  }
  return (c && ie(n, t, e, i)) || h;
}
...
function Ri(s, t, e, i) {
  ...
  for (const a of s) {
    ...
    if (a.horizontal) {
      const d = t.w * h,
        u = c.size || l.height;
      (ue(c.start) && (r = c.start),
        l.fullSize
          ? Pe(l, n.left, r, e.outerWidth - n.right - n.left, u)
          : Pe(l, t.left + c.placed, r, d, u),
        (c.start = r),
        (c.placed += d),
        (r = l.bottom));
    } else {
      const d = t.h * h,
        u = c.size || l.width;
      (ue(c.start) && (o = c.start),
        l.fullSize
          ? Pe(l, o, n.top, u, e.outerHeight - n.bottom - n.top)
          : Pe(l, o, t.top + c.placed, u, d),
        (c.start = o),
        (c.placed += d),
        (o = l.right));
    }
...
var dt = {
  ...
  update(s, t, e, i) {
    if (!s) return;
    const n = ut(s.options.layout.padding),
    ...
    const h =
        l.reduce(
          (m, x) => (x.box.options && x.box.options.display === !1 ? m : m + 1),
          0
        ) || 1,
      d = Object.freeze({
        outerWidth: t,
    ...
    (ie(a.fullSize, f, d, p),
      ie(l, f, d, p),
      ie(c, f, d, p) && ie(l, f, d, p),
      Cl(f),
      Ri(a.leftAndTop, f, d, p),
      (f.x += f.w),
      (f.y += f.h),
      Ri(a.rightAndBottom, f, d, p),
      (s.chartArea = {
        left: f.left,
        top: f.top,
        right: f.left + f.w,
...
const Qn = Na ? { passive: !0 } : !1;
function Tl(s, t, e) {
  s && s.addEventListener(t, e, Qn);
}
function Nl(s, t, e) {
  s && s.canvas && s.canvas.removeEventListener(t, e, Qn);
}
function Rl(s, t) {
  const e = Ol[s.type] || s.type,
    { x: i, y: n } = Lt(s, t);
  return {
    type: e,
    chart: t,
...
function Ll(s, t, e) {
  const i = s.canvas,
    n = new MutationObserver(o => {
      let r = !1;
      for (const a of o)
        ((r = r || $e(a.addedNodes, i)), (r = r && !$e(a.removedNodes, i)));
      r && e();
    });
...
function zl(s, t, e) {
  const i = s.canvas,
    n = new MutationObserver(o => {
      let r = !1;
      for (const a of o)
        ((r = r || $e(a.removedNodes, i)), (r = r && !$e(a.addedNodes, i)));
      r && e();
    });
  return (n.observe(document, { childList: !0, subtree: !0 }), n);
}
...
function Il(s, t) {
  (xe.size || window.addEventListener("resize", to), xe.set(s, t));
}
function Fl(s) {
  (xe.delete(s), xe.size || window.removeEventListener("resize", to));
}
function El(s, t, e) {
  const i = s.canvas,
    n = i && $s(i);
  ...
  return (r.observe(n), Il(s, o), r);
}
function fs(s, t, e) {
  (e && e.disconnect(), t === "resize" && Fl(s));
}
function Bl(s, t, e) {
  const i = s.canvas,
    n = Tn(o => {
...
class Hl extends Zn {
  acquireContext(t, e) {
    ...
    return i && i.canvas === t ? (Al(t, e), i) : null;
  }
  releaseContext(t) {
    const e = t.canvas;
    if (!e[Le]) return !1;
    const i = e[Le].initial;
  ...
  addEventListener(t, e, i) {
    ...
    const n = t.$proxies || (t.$proxies = {}),
      r = { attach: Ll, detach: zl, resize: El }[e] || Bl;
    n[e] = r(t, e, i);
  }
  removeEventListener(t, e) {
    const i = t.$proxies || (t.$proxies = {}),
      n = i[e];
    if (!n) return;
    ((({ attach: fs, detach: fs, resize: fs })[e] || Nl)(t, e, n),
      (i[e] = void 0));
  }
  getDevicePixelRatio() {
...
function Wl(s) {
  return !Vs() || (typeof OffscreenCanvas < "u" && s instanceof OffscreenCanvas)
    ? jl
    : Hl;
}
class ft {
...
(P(ft, "defaults", {}), P(ft, "defaultRoutes"));
function Vl(s, t) {
  const e = s.options.ticks,
    i = $l(s),
    n = Math.min(e.maxTicksLimit || i, i),
    o = e.major.enabled ? Ul(t) : [],
    r = o.length,
    a = o[0],
    l = o[r - 1],
    c = [];
  if (r > n) return (Xl(t, c, o, r / n), c);
  const h = Yl(o, t, n);
  if (r > 0) {
    let d, u;
    const f = r > 1 ? Math.round((l - a) / (r - 1)) : null;
    for (Ce(t, c, h, E(f) ? 0 : a - f, a), d = 0, u = r - 1; d < u; d++)
      Ce(t, c, h, o[d], o[d + 1]);
    return (Ce(t, c, h, l, E(f) ? t.length : l + f), c);
  }
  return (Ce(t, c, h), c);
}
function $l(s) {
...
function Ce(s, t, e, i, n) {
  const o = T(i, 0),
    r = Math.min(T(n, s.length), s.length);
  let a = 0,
    l,
    c,
    h;
...
const Gl = s => (s === "left" ? "right" : s === "right" ? "left" : s),
  Ii = (s, t, e) => (t === "top" || t === "left" ? s[t] + e : s[t] - e),
  Fi = (s, t) => Math.min(t || s, s);
function Ei(s, t) {
  const e = [],
    i = s.length / t,
    n = s.length;
...
function Bi(s, t) {
  ...
  const e = Q(s.font, t),
    i = ut(s.padding);
  return (X(s.text) ? s.text.length : 1) * e.lineHeight + i.height;
}
function Zl(s, t) {
  return Wt(s, { scale: t, type: "scale" });
}
function Ql(s, t, e) {
  return Wt(s, { tick: e, index: t, type: "tick" });
}
function tc(s, t, e) {
  let i = zs(s);
  return (((e && t !== "right") || (!e && t === "right")) && (i = Gl(i)), i);
}
function ec(s, t, e, i) {
  ...
  if (s.isHorizontal()) {
    if (((f = J(i, o, a)), z(e))) {
      ...
      e === "center" ? (p = (c.bottom + c.top) / 2 + m - t) : (p = Ii(s, e, t));
    u = a - o;
  } else {
    if (z(e)) {
      const b = Object.keys(e)[0],
        y = e[b];
      f = h[b].getPixelForValue(y) - x + t;
    } else
      e === "center" ? (f = (c.left + c.right) / 2 - x + t) : (f = Ii(s, e, t));
    ((p = J(i, r, n)), (d = e === "left" ? -q : q));
  }
...
class Gt extends ft {
  ...
  getUserBounds() {
    ...
    return (
      ...
      (e = pt(e, Number.NEGATIVE_INFINITY)),
      (i = pt(i, Number.POSITIVE_INFINITY)),
      (n = pt(n, Number.NEGATIVE_INFINITY)),
      { min: pt(t, i), max: pt(e, n), minDefined: tt(t), maxDefined: tt(e) }
    );
  }
  getMinMax(t) {
    ...
    return (
      (e = o && e > i ? i : e),
      (i = n && e > i ? e : i),
      { min: pt(e, pt(i, e)), max: pt(i, pt(e, i)) }
    );
  }
  getPadding() {
    return {
  ...
  update(t, e, i) {
    ...
    (this.beforeUpdate(),
      ...
      this._dataLimitsCached ||
        ...
        (this._range = ha(this, o, n)),
        (this._dataLimitsCached = !0)),
      this.beforeBuildTicks(),
      (this.ticks = this.buildTicks() || []),
      this.afterBuildTicks());
    const l = a < this.ticks.length;
    (this._convertTicksToLabels(l ? Ei(this.ticks, a) : this.ticks),
      this.configure(),
  ...
  calculateLabelRotation() {
    const t = this.options,
      e = t.ticks,
      i = Fi(this.ticks.length, t.ticks.maxTicksLimit),
      n = e.minRotation || 0,
      o = e.maxRotation;
    let r = n,
      a,
    ...
    const h = this._getLabelSizes(),
      d = h.widest.width,
      u = h.highest.height,
      f = Z(this.chart.width - d, 0, this.maxWidth);
      ...
      d + 6 > a &&
        ...
        (r = Lr(
          Math.min(
            ...
            Math.asin(Z(l / c, -1, 1)) - Math.asin(Z(u / c, -1, 1))
          )
        )),
    ...
    if (r) {
      ...
      if (
        ...
        const {
          ...
          x = Math.sin(p);
        if (a) {
          const b = i.mirror ? 0 : x * d.width + m * u.height;
          t.height = Math.min(this.maxHeight, t.height + b + f);
        } else {
          const b = i.mirror ? 0 : m * d.width + x * u.height;
          t.width = Math.min(this.maxWidth, t.width + b + f);
        }
        this._calculatePadding(c, h, x, m);
      }
    }
    (this._handleMargins(),
      a
  ...
  _calculatePadding(t, e, i, n) {
    ...
    if (this.isHorizontal()) {
      ...
      (l
        ? c
          ? ((u = n * t.width), (f = i * e.height))
          : ((u = i * t.height), (f = n * e.width))
        : o === "start"
          ? (f = e.width)
          : o === "end"
            ? (u = t.width)
  ...
  _computeLabelSizes(t, e, i) {
    ...
    for (d = 0; d < e; d += l) {
      if (
        ...
        ((k = fi(n, b.data, b.gc, k, p)), (v = y));
      else if (X(p))
        for (u = 0, f = p.length; u < f; ++u)
          ((_ = p[u]),
            !E(_) && !X(_) && ((k = fi(n, b.data, b.gc, k, _)), (v += y)));
      (r.push(k), a.push(v), (c = Math.max(k, c)), (h = Math.max(v, h)));
    }
    Jl(o, e);
    const M = r.indexOf(c),
      w = a.indexOf(h),
      S = C => ({ width: r[C] || 0, height: a[C] || 0 });
    return {
      first: S(0),
      last: S(e - 1),
      widest: S(M),
  ...
  getPixelForDecimal(t) {
    ...
    return Ir(this._alignToPixels ? Nt(this.chart, e, 0) : e);
  }
  ...
  getContext(t) {
    ...
    if (t >= 0 && t < e.length) {
      const i = e[t];
      return i.$context || (i.$context = Ql(this.getContext(), t, i));
    }
    ...
    if (r === "top")
      ...
      if (r === "center") y = b((t.top + t.bottom) / 2 + 0.5);
        ...
        const j = Object.keys(r)[0],
          R = r[j];
        y = b(this.chart.scales[j].getPixelForValue(R));
      }
      ((O = t.top), (K = t.bottom), (w = y + x), (C = w + u));
    } else if (e === "y") {
      ...
      ((M = y - x), (S = M - u), (N = t.left), (L = t.right));
    }
    const A = T(n.ticks.maxTicksLimit, d),
      D = Math.max(1, Math.ceil(d / A));
    for (k = 0; k < d; k += D) {
      const j = this.getContext(k),
        ...
        st = R.tickColor,
        rt = R.tickBorderDash || [],
        Y = R.tickBorderDashOffset;
      ((v = ql(this, k, l)),
        v !== void 0 &&
          ((_ = Nt(i, v, F)),
          c ? (M = S = N = L = _) : (w = C = O = K = _),
          f.push({
            tx1: M,
            ty1: w,
            tx2: S,
    ...
    if (n === "top")
      ...
      if (n === "center") M = (t.top + t.bottom) / 2 + f;
        ...
        const D = Object.keys(n)[0],
          j = n[D];
        M = this.chart.scales[D].getPixelForValue(j) + f;
      }
      ...
      if (n === "center") _ = (t.left + t.right) / 2 - f;
        ...
        const D = Object.keys(n)[0],
          j = n[D];
        _ = this.chart.scales[D].getPixelForValue(j);
      }
        ...
        ? ((_ = S),
          ...
          n === "top"
            ? c === "near" || m !== 0
              ? (L = -O * N + N / 2)
              : c === "center"
                ? (L = -A.highest.height / 2 - j * N + N)
                : (L = -A.highest.height + N / 2)
            : c === "near" || m !== 0
              ? (L = N / 2)
              : c === "center"
                ? (L = A.highest.height / 2 - j * N)
                : (L = A.highest.height - O * N),
          d && (L *= -1),
          m !== 0 && !D.showLabelBackdrop && (_ += (N / 2) * Math.sin(m)))
        : ((M = S), (L = ((1 - O) * N) / 2));
      let et;
      if (D.showLabelBackdrop) {
        const gt = ut(D.backdropPadding),
          G = A.heights[b],
          st = A.widths[b];
        let rt = L - gt.top,
          Y = 0 - gt.left;
  ...
  drawBorder() {
    ...
    let c, h, d, u;
    (this.isHorizontal()
      ? ((c = Nt(t, this.left, r) - r / 2),
        (h = Nt(t, this.right, a) + a / 2),
        (d = u = l))
      : ((d = Nt(t, this.top, r) - r / 2),
        (u = Nt(t, this.bottom, a) + a / 2),
        (c = h = l)),
      e.save(),
      (e.lineWidth = o.width),
...
class De {
  ...
  unregister(t) {
    const e = this.items,
      ...
      n = this.scope;
    (i in e && delete e[i],
      n && i in U[n] && (delete U[n][i], this.override && delete Ht[i]));
  }
}
function sc(s, t, e) {
  const i = de(Object.create(null), [e ? U.get(e) : {}, U.get(t), s.defaults]);
  (U.set(t, i),
    s.defaultRoutes && ic(t, s.defaultRoutes),
...
class oc {
  constructor() {
    ((this.controllers = new De(Et, "datasets", !0)),
      (this.elements = new De(ft, "elements")),
      (this.plugins = new De(Object, "plugins")),
      (this.scales = new De(Gt, "scales")),
...
class rc {
  ...
  _createDescriptors(t, e) {
    const i = t && t.config,
      n = T(i.options && i.options.plugins, {}),
      o = ac(i);
    return n === !1 && !e ? [] : cc(t, o, n, e);
  }
...
function ac(s) {
  const t = {},
    e = [],
    i = Object.keys(xt.plugins.items);
  for (let o = 0; o < i.length; o++) e.push(xt.getPlugin(i[o]));
  const n = s.plugins || [];
...
function cc(s, { plugins: t, localIds: e }, i, n) {
  const o = [],
    r = s.getContext();
  for (const a of t) {
    const l = a.id,
    ...
    c !== null &&
      o.push({
        plugin: a,
        options: hc(s.config, { plugin: a, local: e[l] }, c, r),
      });
  }
  return o;
}
function hc(s, { plugin: t, local: e }, i, n) {
...
function Ms(s, ...t) {
  ...
  for (const e of t) {
    const i =
      e.axis || fc(e.position) || (s.length > 1 && Hi(s[0].toLowerCase()));
    if (i) return i;
  }
  throw new Error(
...
function gc(s, t) {
  if (t.data && t.data.datasets) {
    ...
    if (e.length) return Wi(s, "x", e[0]) || Wi(s, "y", e[0]);
  }
  return {};
}
function pc(s, t) {
  const e = Ht[s.type] || { scales: {} },
    i = t.scales || {},
    n = Ss(s.type, t),
  ...
  return (
    Object.keys(i).forEach(r => {
      ...
      const l = Ms(r, a, gc(r, s), U.scales[a.type]),
        c = uc(l, n),
        h = e.scales || {};
      o[r] = re(Object.create(null), [{ axis: l }, a, h[l], h[c]]);
    }),
    s.data.datasets.forEach(r => {
      const a = r.type || s.type,
        l = r.indexAxis || Ss(a, t),
        h = (Ht[a] || {}).scales || {};
      Object.keys(h).forEach(d => {
        const u = dc(d, l),
          f = r[u + "AxisID"] || u;
        ((o[f] = o[f] || Object.create(null)),
          re(o[f], [{ axis: u }, i[f], h[d]]));
      });
    }),
    Object.keys(o).forEach(r => {
      const a = o[r];
      re(a, [U.scales[a.type], U.scale]);
    }),
    o
  );
}
function eo(s) {
  ...
  ((t.plugins = T(t.plugins, {})), (t.scales = pc(s, t)));
}
function so(s) {
  return (
    (s = s || {}),
...
function mc(s) {
  return ((s = s || {}), (s.data = so(s.data)), eo(s), s);
}
const Vi = new Map(),
  io = new Set();
function je(s, t) {
  let e = Vi.get(s);
  return (e || ((e = t()), Vi.set(s, e), io.add(e)), e);
}
const te = (s, t, e) => {
  const i = Bt(t, e);
  i !== void 0 && s.add(i);
...
class xc {
  ...
  getOptionScopes(t, e, i) {
    ...
    e.forEach(h => {
      (t && (l.add(t), h.forEach(d => te(l, t, d))),
        ...
        h.forEach(d => te(l, Ht[o] || {}, d)),
        h.forEach(d => te(l, U, d)),
        h.forEach(d => te(l, vs, d)));
    });
  ...
  chartOptionScopes() {
    ...
    return [t, Ht[e] || {}, U.datasets[e] || {}, { type: e }, U, vs];
  }
  resolveNamedOptions(t, e, i, n = [""]) {
    const o = { $shared: !0 },
      { resolver: r, subPrefixes: a } = $i(this._resolverCache, t, n);
    let l = r;
    if (yc(r, e)) {
      ((o.$shared = !1), (i = At(i) ? i() : i));
  ...
  createResolver(t, e, i = [""], n) {
    const { resolver: o } = $i(this._resolverCache, t, i);
    return z(e) ? Xt(o, e, void 0, n) : o;
  }
}
function $i(s, t, e) {
  let i = s.get(t);
...
const bc = s => z(s) && Object.getOwnPropertyNames(s).some(t => At(s[t]));
function yc(s, t) {
  const { isScriptable: e, isIndexable: i } = zn(s);
  for (const n of t) {
    const o = e(n),
      r = i(n),
      a = (r || o) && s[n];
    if ((o && (At(a) || bc(a))) || (r && X(a))) return !0;
  }
  return !1;
}
var _c = "4.5.1";
const kc = ["top", "bottom", "left", "right", "chartArea"];
function Yi(s, t) {
  return s === "top" || s === "bottom" || (kc.indexOf(s) === -1 && t === "x");
}
function Ui(s, t) {
  return function (e, i) {
...
function Xi(s) {
  ...
  (t.notifyPlugins("afterRender"), V(e && e.onComplete, [s], t));
}
function vc(s) {
  const t = s.chart,
    e = t.options.animation;
  V(e && e.onProgress, [s], t);
}
function no(s) {
  return (
    Vs() && typeof s == "string"
...
let Ze =
  ((Mt = class {
    ...
    constructor(t, e) {
      ...
      ((this.platform = new (i.platform || Wl(n))()),
      ...
      if (
        ...
        (this.scales = {}),
        (this._plugins = new rc()),
        (this.$proxies = {}),
        (this._hiddenIndices = {}),
        (this.attached = !1),
        (this._animationsDisabled = void 0),
        (this.$context = void 0),
        (this._doResize = Hr(d => this.update(d), r.resizeDelay || 0)),
        (this._dataChanges = []),
        (ze[this.id] = this),
        !a || !l)
      ) {
      ...
      (_t.listen(this, "complete", Xi),
        _t.listen(this, "progress", vc),
        this._initialize(),
      ...
      (e &&
        ...
        B(o, r => {
          const a = r.options,
            ...
            c = Ms(l, a),
            h = T(a.type, r.dtype);
          ((a.position === void 0 || Yi(a.position, c) !== Yi(r.dposition)) &&
            (a.position = r.dposition),
            (n[l] = !0));
          let d = null;
          if (l in i && i[l].type === h) d = i[l];
          else {
            const u = xt.getScale(h);
    ...
    buildOrUpdateControllers() {
      ...
      for (
        ...
        if (
          ...
          (r.type = a),
          (r.indexAxis = o.indexAxis || Ss(a, this.options)),
          (r.order = o.order || 0),
          (r.index = i),
          (r.label = "" + o.label),
    ...
    _checkEventBindings() {
      const t = this.options,
        ...
        i = new Set(t.events);
      (!ni(e, i) || !!this._responsiveListeners !== t.responsive) &&
    ...
    _getUniformDataChanges() {
      ...
      const e = this.data.datasets.length,
        ...
        n = i(0);
      for (let o = 1; o < e; o++) if (!ni(n, i(o))) return;
      return Array.from(n)
        .map(o => o.split(","))
    ...
    render() {
      this.notifyPlugins("beforeRender", { cancelable: !0 }) !== !1 &&
        (_t.has(this)
          ? this.attached && !_t.running(this) && _t.start(this)
          : (this.draw(), Xi({ chart: this })));
    }
    draw() {
      let t;
    ...
    getContext() {
      return (
        this.$context ||
        (this.$context = Wt(null, { chart: this, type: "chart" }))
      );
    }
    ...
    _stop() {
      let t, e;
      for (
        this.stop(), _t.remove(this), t = 0, e = this.data.datasets.length;
        t < e;
        ++t
      )
  ...
  Mt);
function Gi() {
  return B(Ze.instances, s => s._plugins.invalidate());
}
function Mc(s, t, e) {
  const {
      startAngle: i,
    ...
    d = Math.min(c / r, lt(i - e));
  if ((s.beginPath(), s.arc(n, o, r - c / 2, i + d / 2, e - d / 2), a > 0)) {
    const u = Math.min(c / a, lt(i - e));
    s.arc(n, o, a + c / 2, e - u / 2, i + u / 2, !0);
  } else {
    const u = Math.min(c / 2, r * lt(i - e));
    if (h === "round") s.arc(n, o, u, e - H / 2, i + H / 2, !0);
    else if (h === "bevel") {
      const f = 2 * u * u,
        p = -f * Math.cos(e + H / 2) + n,
        m = -f * Math.sin(e + H / 2) + o,
        x = f * Math.cos(i + H / 2) + n,
        b = f * Math.sin(i + H / 2) + o;
      (s.lineTo(p, m), s.lineTo(x, b));
    }
  }
  (s.closePath(),
    s.moveTo(0, 0),
...
function Cc(s) {
  return Es(s, ["outerStart", "outerEnd", "innerStart", "innerEnd"]);
}
function Dc(s, t, e, i) {
  const n = Cc(s.options.borderRadius),
    o = (e - t) / 2,
    r = Math.min(o, (i * t) / 2),
    a = l => {
...
function Ye(s, t, e, i, n, o) {
  ...
  const m = Math.max(0.001, p * d - e / H) / d,
    x = (p - m) / 2,
    b = l + x + f,
    y = n - x - f,
    {
  ...
  if ((s.beginPath(), o)) {
    const D = (C + N) / 2;
    if ((s.arc(r, a, d, C, D), s.arc(r, a, d, D, N), v > 0)) {
      const F = $t(S, N, r, a);
      s.arc(F.x, F.y, v, N, y + q);
    }
    const j = $t(L, y, r, a);
    if ((s.lineTo(j.x, j.y), M > 0)) {
      const F = $t(L, A, r, a);
      s.arc(F.x, F.y, M, y + q, A + Math.PI);
    }
    const R = (y - M / u + (b + _ / u)) / 2;
    if (
      (s.arc(r, a, u, y - M / u, R, !0),
      s.arc(r, a, u, R, b + _ / u, !0),
      _ > 0)
    ) {
      const F = $t(O, K, r, a);
      s.arc(F.x, F.y, _, K + Math.PI, b - q);
    }
    const I = $t(w, b, r, a);
    if ((s.lineTo(I.x, I.y), k > 0)) {
      const F = $t(w, C, r, a);
      s.arc(F.x, F.y, k, b - q, C);
    }
  } else {
    s.moveTo(r, a);
    const D = Math.cos(C) * d + r,
      j = Math.sin(C) * d + a;
    s.lineTo(D, j);
    const R = Math.cos(N) * d + r,
      I = Math.sin(N) * d + a;
    s.lineTo(R, I);
  }
  s.closePath();
...
function jc(s, t, e, i, n) {
  ...
  return (Ye(s, t, e, i, l, n), s.fill(), l);
}
function Oc(s, t, e, i, n) {
  ...
  if (o) {
    Ye(s, t, e, i, m, n);
    for (let x = 0; x < o; ++x) s.stroke();
    isNaN(a) || (m = r + (a % $ || $));
  }
  (p && Pc(s, t, m),
    l.selfJoin && m - r >= H && f === 0 && h !== "miter" && Mc(s, t, m),
    o || (Ye(s, t, e, i, m, n), s.stroke()));
}
class ne extends ft {
  constructor(e) {
    super();
  ...
  inRange(e, i, n) {
    const o = this.getProps(["x", "y"], n),
      { angle: r, distance: a } = Dn(o, { x: e, y: i }),
      {
        startAngle: l,
        endAngle: c,
        innerRadius: h,
  ...
  getCenterPoint(e) {
    const {
      ...
      d = (o + r) / 2,
      u = (a + l + h + c) / 2;
    return { x: i + Math.cos(d) * u, y: n + Math.sin(d) * u };
  }
  tooltipPosition(e) {
...
(P(ne, "id", "arc"),
  ...
  P(ne, "defaultRoutes", { backgroundColor: "backgroundColor" }),
  P(ne, "descriptors", {
    _scriptable: !0,
    _indexable: e => e !== "borderDash",
  }));
function oo(s, t, e = t) {
  ((s.lineCap = T(e.borderCapStyle, t.borderCapStyle)),
    s.setLineDash(T(e.borderDash, t.borderDash)),
    (s.lineDashOffset = T(e.borderDashOffset, t.borderDashOffset)),
    (s.lineJoin = T(e.borderJoinStyle, t.borderJoinStyle)),
    (s.lineWidth = T(e.borderWidth, t.borderWidth)),
    (s.strokeStyle = T(e.borderColor, t.borderColor)));
}
function Ac(s, t, e) {
  s.lineTo(e.x, e.y);
}
...
function Nc(s, t, e, i) {
  const { points: n, options: o } = t,
    { count: r, start: a, loop: l, ilen: c } = ro(n, e, i),
    h = Tc(o);
  ...
  for (f = 0; f <= c; ++f)
    ((p = n[(a + (u ? c - f : f)) % r]),
      !p.skip &&
        (d ? (s.moveTo(p.x, p.y), (d = !1)) : h(s, m, p, u, o.stepped),
        (m = p)));
  return (l && ((p = n[(a + (u ? c : 0)) % r]), h(s, m, p, u, o.stepped)), !!l);
}
function Rc(s, t, e, i) {
  const n = t.points,
    { count: o, start: r, ilen: a } = ro(n, e, i),
  ...
  let h = 0,
    ...
    x,
    b;
  const y = v => (r + (c ? a - v : v)) % o,
    k = () => {
      m !== x && (s.lineTo(h, x), s.lineTo(h, m), s.lineTo(h, b));
    };
  for (l && ((f = n[y(0)]), s.moveTo(f.x, f.y)), u = 0; u <= a; ++u) {
    if (((f = n[y(u)]), f.skip)) continue;
    const v = f.x,
      _ = f.y,
      M = v | 0;
    (M === p
      ? (_ < m ? (m = _) : _ > x && (x = _), (h = (d * h + v) / ++d))
      : (k(), s.lineTo(v, _), (p = M), (d = 0), (m = x = _)),
      (b = _));
  }
  k();
}
...
const Fc = typeof Path2D == "function";
function Ec(s, t, e, i) {
  Fc && !t.options.segment ? zc(s, t, e, i) : Ic(s, t, e, i);
}
class Dt extends ft {
  constructor(t) {
    (super(),
  ...
  updateControlPoints(t, e) {
    ...
    if (
      ...
      (Pa(this._points, i, t, n, e), (this._pointsUpdated = !0));
    }
  }
  set points(t) {
    ((this._points = t),
  ...
  interpolate(t, e) {
    ...
    for (c = 0, h = r.length; c < h; ++c) {
      ...
      const m = Math.abs((n - f[e]) / (p[e] - f[e])),
        x = l(f, p, m, i.stepped);
      ((x[e] = t[e]), a.push(x));
    }
  ...
  draw(t, e, i, n) {
    ...
    ((this.points || []).length &&
      o.borderWidth &&
      (t.save(), Ec(t, this, i, n), t.restore()),
...
class Ie extends ft {
  ...
  inXRange(e, i) {
    return qi(this, e, "x", i);
  }
  inYRange(e, i) {
    return qi(this, e, "y", i);
  }
  getCenterPoint(e) {
  ...
  draw(e, i) {
    ...
    this.skip ||
      n.radius < 0.1 ||
      !pe(this, i, this.size(n) / 2) ||
      ((e.strokeStyle = n.borderColor),
      (e.lineWidth = n.borderWidth),
      (e.fillStyle = n.backgroundColor),
      ws(e, n, this.x, this.y));
  }
  getRange() {
...
function gs(s, t, e, i) {
  const n = t === null,
    o = e === null,
    a = s && !(n && o) && ao(s, i);
  return a && (n || St(t, a.left, a.right)) && (o || St(e, a.top, a.bottom));
}
function Vc(s) {
...
function Yc(s, t, e) {
  ...
  for (const a of i) {
    ...
    const d = Yn(t, h);
    for (const u of d) {
      const f = Cs(e, o[u.start], o[u.end], u.loop),
        p = $n(a, n, f);
      for (const m of p)
        r.push({
          source: m,
          target: u,
          start: { [e]: Ji(h, f, "start", Math.max) },
          end: { [e]: Ji(h, f, "end", Math.min) },
        });
    }
  }
  return r;
...
function lo(s, t) {
  let e = [],
    i = !1;
  return (
    X(s) ? ((i = !0), (e = s)) : (e = Uc(s, t)),
    e.length
      ? new Dt({ points: e, options: { tension: 0 }, _loop: i, _fullLoop: i })
      : null
  );
}
function Zi(s) {
...
function Kc(s, t, e) {
  const i = Zc(s);
  if (z(i)) return isNaN(i.value) ? !1 : i;
  let n = parseFloat(i);
  return tt(n) && Math.floor(n) === n
    ? Gc(i[0], t, n, e)
...
function Qc(s) {
  const { scale: t, index: e, line: i } = s,
    ...
    r = i.points,
    a = th(t, e);
  a.push(lo({ x: null, y: t.bottom }, i));
  for (let l = 0; l < o.length; l++) {
    const c = o[l];
    for (let h = c.start; h <= c.end; h++) eh(n, r[h], a);
  }
...
function eh(s, t, e) {
  ...
  for (let n = 0; n < e.length; n++) {
    const o = e[n],
      { first: r, last: a, point: l } = sh(o, t, "x");
    if (!(!l || (r && a))) {
      if (r) i.unshift(l);
...
function ih(s) {
  ...
  if (tt(e)) return nh(t, e);
  if (e === "stack") return Qc(s);
  if (e === "shape") return !0;
  const n = oh(s);
  return n instanceof co ? n : lo(n, i);
}
function nh(s, t) {
...
function oh(s) {
  return (s.scale || {}).getPointPositionForValue ? ah(s) : rh(s);
}
function rh(s) {
...
function lh(s, t) {
  ...
  (o !== n &&
    (c === "x"
      ? (Qi(s, i, r.top),
        xs(s, { line: e, target: i, color: n, scale: a, property: c, clip: l }),
        s.restore(),
        s.save(),
        Qi(s, i, r.bottom))
      : c === "y" &&
        (tn(s, i, r.left),
        xs(s, { line: e, target: i, color: o, scale: a, property: c, clip: l }),
        s.restore(),
        s.save(),
        tn(s, i, r.right),
        (h = n))),
    xs(s, { line: e, target: i, color: h, scale: a, property: c, clip: l }),
    s.restore());
}
function Qi(s, t, e) {
...
function xs(s, t) {
  ...
  for (const { source: c, target: h, start: d, end: u } of l) {
    const { style: { backgroundColor: f = o } = {} } = c,
      p = i !== !0;
    (s.save(), (s.fillStyle = f), ch(s, r, a, p && Cs(n, d, u)), s.beginPath());
    const m = !!e.pathSegment(s, c);
    let x;
    if (p) {
      m ? s.closePath() : en(s, i, u, n);
...
var hh = {
  ...
  afterDatasetsUpdate(s, t, e) {
    ...
    for (r = 0; r < i; ++r)
      ((o = s.getDatasetMeta(r)),
        ...
        n.push(l));
    for (r = 0; r < i; ++r)
      ((l = n[r]), !(!l || l.fill === !1) && (l.fill = Xc(n, r, e.propagate)));
  },
  beforeDraw(s, t, e) {
    ...
    for (let r = n.length - 1; r >= 0; --r) {
      const a = n[r].$filler;
      a &&
        (a.line.updateControlPoints(o, a.axis), i && a.fill && ms(s.ctx, a, o));
    }
  },
  beforeDatasetsDraw(s, t, e) {
    ...
    for (let n = i.length - 1; n >= 0; --n) {
      const o = i[n].$filler;
      Zi(o) && ms(s.ctx, o, s.chartArea);
    }
  },
  beforeDatasetDraw(s, t, e) {
    const i = t.meta.$filler;
    !Zi(i) || e.drawTime !== "beforeDatasetDraw" || ms(s.ctx, i, s.chartArea);
  },
...
class nn extends ft {
  ...
  fit() {
    ...
    const i = t.labels,
      ...
      { boxWidth: a, itemHeight: l } = sn(i, o);
    let c, h;
    ((e.font = n.string),
      this.isHorizontal()
  ...
  _fitRows(t, e, i, n) {
    ...
    return (
      this.legendItems.forEach((p, m) => {
        const x = i + e / 2 + o.measureText(p.text).width;
        ((m === 0 || c[c.length - 1] + x + 2 * a > r) &&
          ((d += h), (c[c.length - (m > 0 ? 0 : 1)] = 0), (f += h), u++),
          (l[m] = { left: 0, top: f, row: u, width: x, height: n }),
          (c[c.length - 1] += x + a));
      }),
      d
    );
  ...
  _fitCols(t, e, i, n) {
    ...
    return (
      this.legendItems.forEach((x, b) => {
        const { itemWidth: y, itemHeight: k } = uh(i, e, o, x, n);
        (b > 0 &&
          f + k + 2 * a > h &&
          ((d += u + a),
          ...
          m++,
          (u = f = 0)),
          (l[b] = { left: p, top: f, col: m, width: y, height: k }),
          (u = Math.max(u, y)),
          (f += k + a));
      }),
      (d += u),
  ...
  adjustHitBoxes() {
    ...
    if (this.isHorizontal()) {
      let a = 0,
        l = J(i, this.left + n, this.right - this.lineWidths[a]);
      for (const c of e)
        (a !== c.row &&
          ((a = c.row),
          (l = J(i, this.left + n, this.right - this.lineWidths[a]))),
      ...
      let a = 0,
        l = J(i, this.top + t + n, this.bottom - this.columnSizes[a].height);
      for (const c of e)
        (c.col !== a &&
          ((a = c.col),
          (l = J(
  ...
  _draw() {
    ...
    (this.drawTitle(),
      ...
      (n.lineWidth = 0.5),
      (n.font = c.string));
    const { boxWidth: p, boxHeight: m, itemHeight: x } = sn(r, d),
      b = function (M, w, S) {
        if (isNaN(p) || p <= 0 || isNaN(m) || m < 0) return;
        n.save();
        const C = T(S.lineWidth, 1);
        if (
          ((n.fillStyle = T(S.fillStyle, a)),
          (n.lineCap = T(S.lineCap, "butt")),
          (n.lineDashOffset = T(S.lineDashOffset, 0)),
          (n.lineJoin = T(S.lineJoin, "miter")),
          (n.lineWidth = C),
          (n.strokeStyle = T(S.strokeStyle, a)),
          ...
          const N = {
            ...
            O = l.xPlus(M, p / 2),
            L = w + u;
          Rn(n, N, O, L, r.pointStyleWidth && p);
        } else {
          const N = w + Math.max((d - m) / 2, 0),
            O = l.leftForLtr(M, p),
            L = Yt(S.borderRadius);
          (n.beginPath(),
            Object.values(L).some(K => K !== 0)
              ? We(n, { x: O, y: N, w: p, h: m, radius: L })
              : n.rect(O, N, p, m),
            n.fill(),
            C !== 0 && n.stroke());
        }
    ...
    (k
      ? (f = {
          x: J(o, this.left + h, this.right - i[0]),
          y: this.top + h + v,
          line: 0,
        })
      : (f = {
      ...
      (l.setWidth(this.width),
        k
          ? w > 0 &&
            ...
            ((L = f.y += _),
            f.line++,
            (O = f.x = J(o, this.left + h, this.right - i[f.line])))
          : w > 0 &&
            L + _ > this.bottom &&
            ((O = f.x = O + e[f.line].width + h),
            f.line++,
            (L = f.y =
              J(o, this.top + v + h, this.bottom - e[f.line].height))));
      const K = l.x(O);
      if (
        (b(K, L, M),
        (O = Wr(C, O + p + u, k ? O + N : this.right, t.rtl)),
        y(l.x(O), L, M),
        k)
      )
        f.x += N + h;
      else if (typeof M.text != "string") {
        const A = c.lineHeight;
        f.y += ho(M, A) + h;
      } else f.y += _;
    }),
  ...
  _getLegendItemAt(t, e) {
    ...
    if (St(t, this.left, this.right) && St(e, this.top, this.bottom)) {
      for (o = this.legendHitBoxes, i = 0; i < o.length; ++i)
        if (
          ((n = o[i]),
          St(t, n.left, n.left + n.width) && St(e, n.top, n.top + n.height))
        )
  ...
  handleEvent(t) {
    const e = this.options;
    if (!ph(t.type, e)) return;
    const i = this._getLegendItemAt(t.x, t.y);
    if (t.type === "mousemove" || t.type === "mouseout") {
      const n = this._hoveredItem,
        o = dh(n, i);
      (n && !o && V(e.onLeave, [t, n, this], this),
        (this._hoveredItem = i),
...
var mh = {
  ...
  _element: nn,
  start(s, t, e) {
    const i = (s.legend = new nn({ ctx: s.ctx, options: e, chart: s }));
    (dt.configure(s, i, e), dt.addBox(s, i));
  },
  stop(s) {
    (dt.removeBox(s, s.legend), delete s.legend);
  },
  beforeUpdate(s, t, e) {
    const i = s.legend;
    (dt.configure(s, i, e), (i.options = e));
  },
  afterUpdate(s) {
    const t = s.legend;
...
class uo extends ft {
  ...
  update(t, e) {
    ...
    const n = X(i.text) ? i.text.length : 1;
  ...
  _drawArgs(t) {
    ...
    return (
      this.isHorizontal()
        ? ((h = J(a, i, o)), (d = e + t), (c = o - i))
        : (r.position === "left"
            ? ((h = i + t), (d = J(a, n, e)), (l = H * -0.5))
            : ((h = o - t), (d = J(a, e, n)), (l = H * 0.5)),
          (c = n - e)),
...
function xh(s, t) {
  const e = new uo({ ctx: s.ctx, options: t, chart: s });
  (dt.configure(s, e, t), dt.addBox(s, e), (s.titleBlock = e));
}
var bh = {
  id: "title",
  _element: uo,
  ...
  stop(s) {
    ...
    (dt.removeBox(s, t), delete s.titleBlock);
  },
  beforeUpdate(s, t, e) {
...
function mt(s, t) {
  return (t && (X(t) ? Array.prototype.push.apply(s, t) : s.push(t)), s);
}
function kt(s) {
...
function on(s, t) {
  ...
  if (
    ...
    d &&
      (m += d * c.lineHeight + (d - 1) * t.titleSpacing + t.titleMarginBottom),
    b)
  ) {
    const v = t.displayColors ? Math.max(a, l.lineHeight) : l.lineHeight;
    m += f * v + (b - f) * l.lineHeight + (b - 1) * t.bodySpacing;
  }
  u && (m += t.footerMarginTop + u * h.lineHeight + (u - 1) * t.footerSpacing);
  let y = 0;
  const k = function (v) {
    x = Math.max(x, e.measureText(v).width + y);
  };
  return (
    e.save(),
    (e.font = c.string),
    B(s.title, k),
    (e.font = l.string),
    B(s.beforeBody.concat(s.afterBody), k),
    (y = t.displayColors ? r + 2 + t.boxPadding : 0),
    B(i, v => {
      (B(v.before, k), B(v.lines, k), B(v.after, k));
    }),
    (y = 0),
    (e.font = h.string),
    B(s.footer, k),
...
function rn(s, t, e) {
  const i = e.yAlign || t.yAlign || _h(s, e);
  return { xAlign: e.xAlign || t.xAlign || vh(s, t, e, i), yAlign: i };
}
function wh(s, t) {
  let { x: e, width: i } = s;
...
function an(s, t, e, i) {
  const { caretSize: n, caretPadding: o, cornerRadius: r } = s,
    { xAlign: a, yAlign: l } = e,
    c = n + o,
    { topLeft: h, topRight: d, bottomLeft: u, bottomRight: f } = Yt(r);
  let p = wh(t, a);
  const m = Sh(t, l, c);
  return (
    l === "center"
    ...
    { x: Z(p, 0, i.width - t.width), y: Z(m, 0, i.height - t.height) }
  );
}
function Oe(s, t, e) {
...
function Mh(s, t, e) {
  return Wt(s, { tooltip: t, tooltipItems: e, type: "tooltip" });
}
function cn(s, t) {
...
function it(s, t, e, i) {
  ...
  return typeof n > "u" ? fo[t].call(e, i) : n;
}
class Ds extends ft {
  constructor(t) {
    (super(),
  ...
  _resolveAnimations() {
    ...
    const e = this.chart,
      ...
      o = new Xn(this.chart, n);
    return (n._cacheable && (this._cachedAnimations = Object.freeze(o)), o);
  }
  getContext() {
    return (
      this.$context ||
      (this.$context = Mh(this.chart.getContext(), this, this._tooltipItems))
    );
  }
  getTitle(t, e) {
    const { callbacks: i } = e,
      n = it(i, "beforeTitle", this, t),
      o = it(i, "title", this, t),
      r = it(i, "afterTitle", this, t);
    let a = [];
    return ((a = mt(a, kt(n))), (a = mt(a, kt(o))), (a = mt(a, kt(r))), a);
  }
  getBeforeBody(t, e) {
    return ln(it(e.callbacks, "beforeBody", this, t));
  }
  getBody(t, e) {
    const { callbacks: i } = e,
      n = [];
    return (
      B(t, o => {
        const r = { before: [], lines: [], after: [] },
          a = cn(i, o);
        (mt(r.before, kt(it(a, "beforeLabel", this, o))),
          mt(r.lines, it(a, "label", this, o)),
          mt(r.after, kt(it(a, "afterLabel", this, o))),
          n.push(r));
      }),
      n
    );
  ...
  getAfterBody(t, e) {
    return ln(it(e.callbacks, "afterBody", this, t));
  }
  getFooter(t, e) {
    const { callbacks: i } = e,
      n = it(i, "beforeFooter", this, t),
      o = it(i, "footer", this, t),
      r = it(i, "afterFooter", this, t);
    let a = [];
    return ((a = mt(a, kt(n))), (a = mt(a, kt(o))), (a = mt(a, kt(r))), a);
  }
  _createItems(t) {
    ...
    let a = [],
      l,
      c;
    for (l = 0, c = e.length; l < c; ++l) a.push(yh(this.chart, e[l]));
    return (
      t.filter && (a = a.filter((h, d, u) => t.filter(h, d, u, i))),
      t.itemSort && (a = a.sort((h, d) => t.itemSort(h, d, i))),
      B(a, h => {
        const d = cn(t.callbacks, h);
        (n.push(it(d, "labelColor", this, h)),
          o.push(it(d, "labelPointStyle", this, h)),
          r.push(it(d, "labelTextColor", this, h)));
      }),
      (this.labelColors = n),
  ...
  update(t, e) {
    ...
    if (!n.length) this.opacity !== 0 && (o = { opacity: 0 });
      ...
      const a = oe[i.position].call(this, n, this._eventPosition);
      ...
      const l = (this._size = on(this, i)),
        c = Object.assign({}, a, l),
        h = rn(this.chart, i, c),
        d = an(i, c, h, this.chart);
  ...
  getCaretPosition(t, e, i) {
    ...
    return (
      o === "center"
        ? ((v = f + m / 2),
          n === "left"
            ? ((x = u), (b = x - r), (k = v + r), (_ = v - r))
            : ((x = u + p), (b = x + r), (k = v - r), (_ = v + r)),
          (y = x))
        : (n === "left"
            ? (b = u + Math.max(l, h) + r)
            : n === "right"
              ? (b = u + p - Math.max(c, d) - r)
              : (b = this.caretX),
          o === "top"
            ? ((k = f), (v = k - r), (x = b - r), (y = b + r))
            : ((k = f + m), (v = k + r), (x = b + r), (y = b - r)),
          (_ = k)),
      { x1: x, x2: b, x3: y, y1: k, y2: v, y3: _ }
    );
  }
  drawTitle(t, e, i) {
    const n = this.title,
    ...
    let r, a, l;
    if (o) {
      const c = Ut(i.rtl, this.x, this.width);
      for (
        t.x = Oe(this, i.titleAlign, i),
  ...
  _drawColorBox(t, e, i, n, o) {
    ...
    if (o.usePointStyle) {
      ...
      ((t.lineWidth = z(r.borderWidth)
        ? Math.max(...Object.values(r.borderWidth))
        : r.borderWidth || 1),
        (t.strokeStyle = r.borderColor),
        t.setLineDash(r.borderDash || []),
        (t.lineDashOffset = r.borderDashOffset || 0));
      const m = n.leftForLtr(u, c),
        x = n.leftForLtr(n.xPlus(u, 1), c - 2),
        b = Yt(r.borderRadius);
      Object.values(b).some(y => y !== 0)
        ? (t.beginPath(),
          (t.fillStyle = o.multiKeyBackground),
          We(t, { x: m, y: p, w: c, h: l, radius: b }),
          t.fill(),
          t.stroke(),
          (t.fillStyle = r.backgroundColor),
          t.beginPath(),
          We(t, { x, y: p + 1, w: c - 2, h: l - 2, radius: b }),
          t.fill())
        : ((t.fillStyle = o.multiKeyBackground),
          t.fillRect(m, p, c, l),
          t.strokeRect(m, p, c, l),
          (t.fillStyle = r.backgroundColor),
          t.fillRect(x, p + 1, c - 2, l - 2));
    }
  ...
  drawBody(t, e, i) {
    ...
    let u = d.lineHeight,
      f = 0;
    const p = Ut(i.rtl, this.x, this.width),
      m = function (S) {
    ...
    for (
      e.textAlign = r,
        ...
        B(this.beforeBody, m),
        f = a && x !== "right" ? (r === "center" ? c / 2 + h : c + 2 + h) : 0,
        v = 0,
        M = n.length;
      v < M;
      ++v
      ...
      for (
        ...
        (m(k[_]), (u = d.lineHeight));
      B(b.after, m);
    }
    ((f = 0), (u = d.lineHeight), B(this.afterBody, m), (t.y -= o));
  }
  drawFooter(t, e, i) {
    const n = this.footer,
      o = n.length;
    let r, a;
    if (o) {
      const l = Ut(i.rtl, this.x, this.width);
      for (
        t.x = Oe(this, i.footerAlign, i),
...
var Ph = {
  ...
  positioners: oe,
  afterInit(s, t, e) {
    e && (s.tooltip = new Ds({ chart: s, options: e }));
  },
  beforeUpdate(s, t, e) {
  ...
  afterDraw(s) {
    ...
    if (t && t._willRender()) {
      const e = { tooltip: t };
      if (s.notifyPlugins("beforeTooltipDraw", { ...e, cancelable: !0 }) === !1)
        return;
...
function Dh(s, t, e, i) {
  const n = s.indexOf(t);
  if (n === -1) return Ch(s, t, e, i);
  const o = s.lastIndexOf(t);
  return n !== o ? e : n;
}
const jh = (s, t) => (s === null ? null : Z(Math.round(s), 0, t));
function hn(s) {
...
class js extends Gt {
  ...
  parse(t, e) {
    ...
    return (
      (e =
        isFinite(e) && i[e] === t ? e : Dh(i, t, T(e, t), this._addedLabels)),
      jh(e, i.length - 1)
    );
  }
  determineDataLimits() {
...
(P(js, "id", "category"), P(js, "defaults", { ticks: { callback: hn } }));
function Oh(s, t) {
  const e = [],
    {
      bounds: n,
  ...
  let _ = ri((x - m) / p / f) * f,
    ...
    S,
    C;
  if (_ < 1e-14 && !b && !y) return [{ value: m }, { value: x }];
  ((C = Math.ceil(x / _) - Math.floor(m / _)),
    C > p && (_ = ri((C * _) / p / f) * f),
    E(l) || ((M = Math.pow(10, l)), (_ = Math.ceil(_ * M) / M)),
    n === "ticks"
      ? ((w = Math.floor(m / _) * _), (S = Math.ceil(x / _) * _))
      : ((w = m), (S = x)),
    b && y && o && Nr((a - r) / o, _ / 1e3)
      ? ((C = Math.round(Math.min((a - r) / _, h))),
        (_ = (a - r) / C),
        (w = r),
        (S = a))
      : k
        ? ((w = b ? r : w), (S = y ? a : S), (C = c - 1), (_ = (S - w) / C))
        : ((C = (S - w) / _),
          ae(C, Math.round(C), _ / 1e3)
            ? (C = Math.round(C))
            : (C = Math.ceil(C))));
  const N = Math.max(ai(_), ai(w));
  ((M = Math.pow(10, E(l) ? N : l)),
    (w = Math.round(w * M) / M),
    (S = Math.round(S * M) / M));
  let O = 0;
  for (
    ...
    (u && w !== r
      ? (e.push({ value: r }),
        w < r && O++,
        ae(Math.round((w + O * _) * M) / M, r, dn(r, v, s)) && O++)
      : w < r && O++);
    O < C;
    ++O
  ) {
    const L = Math.round((w + O * _) * M) / M;
    if (y && L > a) break;
    e.push({ value: L });
  }
  return (
    y && u && S !== a
      ? e.length && ae(e[e.length - 1].value, a, dn(a, v, s))
        ? (e[e.length - 1].value = a)
        : e.push({ value: a })
      : (!y || S === a) && e.push({ value: S }),
    e
  );
}
function dn(s, t, { horizontal: e, minRotation: i }) {
  const n = wt(i),
...
(P(Os, "id", "linear"),
  P(Os, "defaults", { ticks: { callback: Nn.formatters.numeric } }));
const ts = {
...
function fn(s, t) {
  ...
  return (
    ...
    tt(r) || (r = typeof i == "string" ? e.parse(r, i) : e.parse(r)),
    r === null
      ? null
      : (n &&
          (r =
...
function gn(s, t, e, i) {
  const n = nt.length;
  for (let o = nt.indexOf(s); o < n - 1; ++o) {
    const r = ts[nt[o]],
      a = r.steps ? r.steps : Number.MAX_SAFE_INTEGER;
    if (r.common && Math.ceil((e - t) / (a * r.size)) <= i) return nt[o];
  }
  return nt[n - 1];
}
function Th(s, t, e, i, n) {
  for (let o = nt.length - 1; o >= nt.indexOf(e); o--) {
    const r = nt[o];
    if (ts[r].common && s._adapter.diff(n, i, r) >= t - 1) return r;
  }
  return nt[e ? nt.indexOf(e) : 0];
}
function Nh(s) {
  for (let t = nt.indexOf(s) + 1, e = nt.length; t < e; ++t)
    if (ts[nt[t]].common) return nt[t];
}
function pn(s, t, e) {
  if (!e) s[t] = !0;
  else if (e.length) {
    const { lo: i, hi: n } = Ls(e, t),
      o = e[i] >= t ? e[i] : e[n];
    s[o] = !0;
  }
}
...
class Ue extends Gt {
  ...
  init(t, e = {}) {
    const i = t.time || (t.time = {}),
      n = (this._adapter = new ml._date(t.adapters.date));
    (n.init(e),
      re(i.displayFormats, n.formats()),
      (this._parseOpts = {
        parser: i.parser,
        round: i.round,
  ...
  determineDataLimits() {
    ...
    ((!r || !a) &&
      ...
      (t.bounds !== "ticks" || t.ticks.source !== "labels") &&
        l(this.getMinMax(!1))),
      (n = tt(n) && !isNaN(n) ? n : +e.startOf(Date.now(), i)),
      (o = tt(o) && !isNaN(o) ? o : +e.endOf(Date.now(), i) + 1),
  ...
  buildTicks() {
    ...
    return (
      (this._unit =
        e.unit ||
        (i.autoSkip
          ? gn(e.minUnit, this.min, this.max, this._getLabelCapacity(o))
          : Th(this, a.length, e.minUnit, this.min, this.max))),
      (this._majorUnit =
        !i.major.enabled || this._unit === "year" ? void 0 : Nh(this._unit)),
      this.initOffsets(n),
      t.reverse && a.reverse(),
      mn(this, a, this._majorUnit)
    );
  }
  afterAutoSkip() {
  ...
  _generate() {
    const t = this._adapter,
      ...
      n = this.options,
      o = n.time,
      r = o.unit || gn(o.minUnit, e, i, this._getLabelCapacity(e)),
      a = T(n.ticks.stepSize, 1),
    ...
    for (u = d, f = 0; u < i; u = +t.add(u, a, r), f++) pn(h, u, p);
    return (
      (u === i || n.bounds === "ticks" || f === 1) && pn(h, u, p),
      Object.keys(h)
        .sort(un)
        .map(m => +m)
    );
  ...
  _getLabelCapacity(t) {
    const e = this.options.time,
      ...
      o = this._tickFormatFunction(t, 0, mn(this, [t], this._majorUnit), n),
  ...
  getLabelTimestamps() {
    ...
    for (e = 0, i = n.length; e < i; ++e) t.push(fn(this, n[e]));
...
function Ae(s, t, e) {
  let i = 0,
    ...
    l;
  e
    ? (t >= s[i].pos && t <= s[n].pos && ({ lo: i, hi: n } = It(s, "pos", t)),
      ({ pos: o, time: a } = s[i]),
      ({ pos: r, time: l } = s[n]))
    : (t >= s[i].time &&
        t <= s[n].time &&
        ({ lo: i, hi: n } = It(s, "time", t)),
      ({ time: o, pos: a } = s[i]),
      ({ time: r, pos: l } = s[n]));
  const c = r - o;
...
class xn extends Ue {
  ...
  getValueForPixel(t) {
    const e = this._offsets,
      i = this.getDecimalForPixel(t) / e.factor - e.end;
    return Ae(this._table, i * this._tableRange + this._minPos, !0);
  }
}
(P(xn, "id", "timeseries"), P(xn, "defaults", Ue.defaults));
const go = "label";
function bn(s, t) {
...
function zh(s, t = go) {
  ...
  return (po(e, s.labels), mo(e, s.datasets, t), e);
}
function Ih(s, t) {
  const {
      height: e = 150,
    ...
    x = () => {
      (bn(t, null), p.current && (p.current.destroy(), (p.current = null)));
    };
  return (
    W.useEffect(() => {
      !n && p.current && l && Lh(p.current, l);
    }, [n, l]),
    W.useEffect(() => {
      !n && p.current && po(p.current.config.data, a.labels);
    }, [n, a.labels]),
    W.useEffect(() => {
      !n && p.current && a.datasets && mo(p.current.config.data, a.datasets, o);
    }, [n, a.datasets]),
    W.useEffect(() => {
      p.current && (n ? (x(), setTimeout(m)) : p.current.update(d));
    }, [n, l, a.labels, a.datasets, d]),
    W.useEffect(() => {
      p.current && (x(), setTimeout(m));
    }, [r]),
    W.useEffect(() => (m(), () => x()), []),
    g.jsx("canvas", {
      ref: f,
...
const Fh = W.forwardRef(Ih);
function Us(s, t) {
  return (
    Ze.register(t),
    W.forwardRef((e, i) => g.jsx(Fh, { ...e, ref: i, type: s }))
  );
}
const Eh = Us("line", Re),
  Bh = Us("bar", Ne),
  Hh = Us("doughnut", se);
Ze.register(js, Os, Ie, Dt, Fe, ne, bh, Ph, mh, hh);
function Jh() {
  const { state: s } = Po(),
    t = kn(),
    { currentStation: e } = _n(),
    {
      ...
      isSyncing: o,
      syncNow: r,
    } = yn(t.currentCountry.id),
    [a, l] = W.useState(new Date()),
    c = (e == null ? void 0 : e.location) || "Nairobi",
    h = Co(i, c),
    d = h.isRegional
      ? h.petrol
      : ((i == null ? void 0 : i.petrolPrice) ?? s.pmsPrice),
    u = h.isRegional
      ? h.diesel
      : ((i == null ? void 0 : i.dieselPrice) ?? s.agoPrice),
    f = t.currencySymbol,
    [p, m] = W.useState({ revenue: 0, profit: 0, fuelSold: 0, debt: 0 });
  (W.useEffect(() => {
    const A = setInterval(() => l(new Date()), 1e3);
    return () => clearInterval(A);
  }, []),
    W.useEffect(() => {
      const A = { revenue: x, profit: b, fuelSold: y, debt: k },
        D = 1e3,
        j = 30,
        R = D / j;
      let I = 0;
      const F = setInterval(() => {
        I++;
        const ot = I / j,
          et = 1 - Math.pow(1 - ot, 3);
        (m({
          revenue: A.revenue * et,
          profit: A.profit * et,
          fuelSold: A.fuelSold * et,
          debt: A.debt * et,
        }),
          I >= j && clearInterval(F));
      }, R);
  ...
  const {
      ...
      const A = Object.values(s.salesHistory);
      let D = 0,
        j = 0,
        R = 0,
        I = 0;
      (A.forEach(G => {
        const st = (G.pmsPumps || []).reduce(
            (Y, at) => Y + (at.salesKsh || 0),
            0
          ),
          rt = (G.agoPumps || []).reduce((Y, at) => Y + (at.salesKsh || 0), 0);
        ((D += st + rt),
          (R += (G.pmsPumps || []).reduce((Y, at) => Y + (at.salesL || 0), 0)),
          (R += (G.agoPumps || []).reduce((Y, at) => Y + (at.salesL || 0), 0)),
          (j += (G.expenses || []).reduce((Y, at) => Y + (at.amount || 0), 0)));
      }),
        (I = D - j));
      const F = s.deliveryData.totals.balanceDue,
        ot = new Date().toISOString().split("T")[0],
        et = Object.entries(s.salesHistory).find(([G]) => G.startsWith(ot)),
        gt = et
          ? (() => {
              const G = et[1],
                st = (G.pmsPumps || []).reduce(
                  (Y, at) => Y + (at.salesKsh || 0),
                  0
                ),
                rt = (G.agoPumps || []).reduce(
                  (Y, at) => Y + (at.salesKsh || 0),
                  0
                );
              return st + rt;
    ...
    }, [s.salesHistory, s.deliveryData.totals]),
    M = W.useMemo(() => {
      const A = [],
        D = [],
        j = [];
      for (let R = 6; R >= 0; R--) {
        ...
        A.push(I.toLocaleDateString("en-US", { weekday: "short" }));
        let ot = 0,
          et = 0;
        (Object.entries(s.salesHistory).forEach(([gt, G]) => {
          gt.startsWith(F) &&
            ((ot += (G.pmsPumps || []).reduce(
              (st, rt) => st + (rt.salesKsh || 0),
              0
            )),
            (et += (G.agoPumps || []).reduce(
              (st, rt) => st + (rt.salesKsh || 0),
              0
            )));
        }),
    ...
    w = W.useMemo(() => {
      ...
      return (
        A.forEach(R => {
          ((D += (R.pmsPumps || []).reduce((I, F) => I + (F.salesL || 0), 0)),
            (j += (R.agoPumps || []).reduce((I, F) => I + (F.salesL || 0), 0)));
        }),
        D === 0 && j === 0 && ((D = 1), (j = 1)),
        {
    ...
    S = W.useMemo(() => {
      const A = {};
      Object.values(s.salesHistory).forEach(R => {
        (R.expenses || []).forEach(I => {
          const F = I.desc || "Other";
          A[F] = (A[F] || 0) + (I.amount || 0);
        });
      });
      const D = Object.keys(A).slice(0, 6),
        j = D.map(R => A[R]);
      return (
        D.length === 0 && (D.push("No Data"), j.push(0)),
        {
          labels: D,
          datasets: [
            {
    ...
    C = {
      ...
      plugins: {
        legend: {
          position: "bottom",
          labels: {
            color: s.theme === "dark" ? "#9ca3af" : "#374151",
            usePointStyle: !0,
            padding: 16,
          },
        },
      ...
      scales: {
        x: {
          ...
          ticks: { color: s.theme === "dark" ? "#9ca3af" : "#6b7280" },
        },
        y: {
          grid: {
            color:
    ...
    K = A => {
      window.dispatchEvent(new CustomEvent("changeTab", { detail: A }));
    };
  return g.jsxs("div", {
    className: "space-y-6",
    children: [
      g.jsxs("div", {
        ...
        children: [
          g.jsxs("div", {
            children: [
              g.jsx("h2", {
                ...
                children: s.companyData.name || "Dashboard",
              }),
              g.jsx("p", {
          ...
          g.jsxs("div", {
            className: "flex items-center gap-3",
            children: [
              g.jsx(Do, { countryCode: t.currentCountry.id, compact: !0 }),
              g.jsxs("div", {
                className:
                  "flex items-center gap-3 bg-white dark:bg-gray-800 rounded-xl px-4 py-2.5 shadow-sm border border-gray-200 dark:border-gray-700",
                children: [
                  g.jsx(jo, { size: 18, className: "text-blue-500" }),
                  g.jsx("span", {
                    className:
                      "text-sm font-mono text-gray-700 dark:text-gray-300",
                    children: a.toLocaleString("en-KE", {
                      weekday: "short",
                      year: "numeric",
                      month: "short",
                      day: "numeric",
      ...
      g.jsxs("div", {
        ...
        children: [
          g.jsxs("div", {
            className:
              "bg-white dark:bg-gray-800 rounded-xl p-5 shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow",
            children: [
              g.jsxs("div", {
                ...
                children: [
                  ...
                  g.jsx("div", {
                    className:
                      "p-2 bg-green-100 dark:bg-green-900/30 rounded-lg",
                    children: g.jsx(Oo, {
                      size: 18,
              ...
              g.jsxs("p", {
                className: "text-2xl font-bold text-gray-900 dark:text-white",
                children: ["Ksh ", ct(p.revenue, 0)],
              }),
              g.jsxs("div", {
                className: "flex items-center gap-1 mt-2",
                children: [
                  g.jsx(Zs, { size: 14, className: "text-green-500" }),
                  g.jsx("span", {
                    className: "text-xs text-green-600 dark:text-green-400",
                    children: _ > 0 ? `Ksh ${ct(_)} today` : "No sales today",
                  }),
                ],
              }),
            ],
            ...
            children: [
              g.jsxs("div", {
                ...
                children: [
                  ...
                  g.jsx("div", {
                    className: `p-2 rounded-lg ${b >= 0 ? "bg-green-100 dark:bg-green-900/30" : "bg-red-100 dark:bg-red-900/30"}`,
                    children:
                      b >= 0
                        ? g.jsx(Ao, {
                            size: 18,
              ...
              g.jsxs("p", {
                className: `text-2xl font-bold ${b >= 0 ? "text-gray-900 dark:text-white" : "text-red-600 dark:text-red-400"}`,
                children: ["Ksh ", ct(p.profit, 0)],
              }),
              g.jsxs("div", {
                className: "flex items-center gap-1 mt-2",
                children: [
                  b >= 0
                    ? g.jsx(Zs, { size: 14, className: "text-green-500" })
                    : g.jsx(Eo, { size: 14, className: "text-red-500" }),
                  g.jsx("span", {
                    className: "text-xs text-gray-500 dark:text-gray-400",
                    children:
                      v > 0 ? `Ksh ${ct(v)} expenses` : "No expenses recorded",
                  }),
                ],
              }),
            ],
          ...
          g.jsxs("div", {
            ...
            children: [
              ...
              g.jsxs("p", {
                className: "text-2xl font-bold text-gray-900 dark:text-white",
                children: [ct(p.fuelSold, 0), " L"],
              }),
              g.jsxs("div", {
                className: "flex items-center gap-1 mt-2",
                children: [
                  g.jsx(Te, { size: 14, className: "text-blue-500" }),
                  g.jsxs("span", {
                    className: "text-xs text-gray-500 dark:text-gray-400",
                    children: [
                      "PMS: ",
            ...
            children: [
              g.jsxs("div", {
                ...
                children: [
                  ...
                  g.jsx("div", {
                    className: `p-2 rounded-lg ${k > 0 ? "bg-red-100 dark:bg-red-900/30" : "bg-green-100 dark:bg-green-900/30"}`,
                    children:
                      k > 0
                        ? g.jsx(To, {
                            size: 18,
              ...
              g.jsxs("p", {
                className: `text-2xl font-bold ${k > 0 ? "text-red-600 dark:text-red-400" : "text-gray-900 dark:text-white"}`,
                children: ["Ksh ", ct(p.debt, 0)],
              }),
              g.jsxs("div", {
                className: "flex items-center gap-1 mt-2",
                children: [
                  g.jsx(Ro, { size: 14, className: "text-gray-500" }),
                  g.jsxs("span", {
                    className: "text-xs text-gray-500 dark:text-gray-400",
                    children: [Object.keys(s.clients).length, " client(s)"],
                  }),
                ],
              }),
            ],
      ...
      g.jsxs("div", {
        ...
        children: [
          g.jsxs("div", {
            className: `rounded-xl p-5 border shadow-sm ${i ? "bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/10 border-blue-200 dark:border-blue-800" : "bg-gray-50 dark:bg-gray-800/50 border-gray-200 dark:border-gray-700"}`,
            children: [
              g.jsxs("div", {
                className: "flex items-center justify-between mb-3",
                children: [
                  g.jsxs("h3", {
                    className:
                      "text-sm font-semibold text-blue-900 dark:text-blue-200 flex items-center gap-2",
                    children: [
                      g.jsx(ss, {
                        size: 14,
                        className: o
                  ...
                  g.jsx("span", {
                    className:
                      "text-[9px] bg-blue-100 dark:bg-blue-800 text-blue-700 dark:text-blue-300 px-2 py-0.5 rounded-full font-medium",
                    children:
                      (i == null ? void 0 : i.priceSettingBody) ||
                      t.currentCountry.fuelRegulations.priceSettingBody,
                  }),
                ],
              }),
              g.jsx("div", {
                className: "mb-2",
                children: g.jsx("span", {
                  className: `text-[10px] px-2 py-0.5 rounded-full font-medium ${h.isRegional ? "bg-green-100 dark:bg-green-800 text-green-700 dark:text-green-300" : "bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400"}`,
                  children: h.isRegional
                    ? `EPRA ${h.cityName} Price`
                    : `${c} - National Average`,
                }),
              }),
              g.jsxs("div", {
                ...
                children: [
                  g.jsxs("div", {
                    className:
                      "bg-white dark:bg-gray-800 rounded-lg p-3 text-center",
                    children: [
                      g.jsx("p", {
                        className:
                          "text-[10px] text-gray-500 uppercase tracking-wide",
                        children: "Super Petrol",
                      }),
                      g.jsxs("p", {
                        className:
                      ...
                      h.isRegional &&
                        g.jsx("p", {
                          className:
                            "text-[9px] text-green-600 dark:text-green-400 mt-0.5",
                          children: h.cityName,
                        }),
                    ],
                  }),
                  g.jsxs("div", {
                    ...
                    children: [
                      ...
                      g.jsxs("p", {
                        className:
                          "text-xl font-bold text-amber-700 dark:text-amber-400",
                        children: [f, " ", u.toFixed(2)],
                      }),
                      g.jsx("p", {
                        className: "text-[9px] text-gray-400",
                        children: "per litre",
                      ...
                      h.isRegional &&
                        g.jsx("p", {
                          className:
                            "text-[9px] text-amber-600 dark:text-amber-400 mt-0.5",
                          children: h.cityName,
                        }),
                    ],
                  }),
              ...
              (i == null ? void 0 : i.breakdown) &&
                g.jsx("div", {
                  className:
                    "mt-3 pt-3 border-t border-blue-200/50 dark:border-blue-800/30",
                  children: g.jsxs("div", {
                        ...
                        children: [
                          ...
                          g.jsxs("p", {
                            ...
                            children: [
                              f,
                              " ",
                              i.breakdown.landedCost.toFixed(2),
                            ],
                          }),
                        ],
                      }),
                      g.jsxs("div", {
                        children: [
                          ...
                          g.jsxs("p", {
                            className:
                              "text-xs font-semibold text-gray-700 dark:text-gray-300",
                            children: [f, " ", i.breakdown.taxes.toFixed(2)],
                          }),
                        ],
                      }),
                      g.jsxs("div", {
                        children: [
                          ...
                          g.jsxs("p", {
                            className:
                              "text-xs font-semibold text-gray-700 dark:text-gray-300",
                            children: [f, " ", i.breakdown.margins.toFixed(2)],
                          }),
                        ],
                      }),
                    ],
                ...
                children: [
                  i
                    ...
                    : g.jsxs("button", {
                        onClick: r,
                        className:
                          "text-[9px] text-blue-500 hover:underline flex items-center gap-1",
                        children: [
                          g.jsx(Lo, { size: 8 }),
                          " Click to sync latest prices",
                        ],
                      }),
                  g.jsx("p", {
                    className: "text-[9px] text-gray-400",
          ...
          g.jsxs("div", {
            className:
              "bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/10 rounded-xl p-5 border border-purple-200 dark:border-purple-800 shadow-sm",
            children: [
              g.jsxs("h3", {
                className:
                  "text-sm font-semibold text-purple-900 dark:text-purple-200 mb-3 flex items-center gap-2",
                children: [
                  g.jsx(bs, { size: 14, className: "text-purple-500" }),
                  "Tax & Statutory Rates",
                ],
              }),
              g.jsxs("div", {
                ...
                children: [
                  g.jsxs("div", {
                    ...
                    children: [
                      ...
                      g.jsxs("span", {
                        ...
                        children: [(n || t.revenueAuthority).vatRate, "%"],
                      }),
                    ],
                  }),
                  g.jsxs("div", {
                    ...
                    children: [
                      ...
                      g.jsxs("span", {
                        ...
                        children: [
                          (
                            (n || t.payrollConfig).nssfEmployeeRate * 100
                          ).toFixed(0),
                          "%",
                        ],
                      }),
                  ...
                  g.jsxs("div", {
                    ...
                    children: [
                      ...
                      g.jsxs("span", {
                        ...
                        children: [
                          (
                            (n || t.payrollConfig).nssfEmployerRate * 100
                          ).toFixed(0),
                          "%",
                        ],
                      }),
                  ...
                  ((n == null ? void 0 : n.housingLevyApplicable) ??
                    t.payrollConfig.housingLevy) &&
                    g.jsxs("div", {
                      className: "flex justify-between text-xs",
                      children: [
                        g.jsx("span", {
                          className: "text-gray-600 dark:text-gray-400",
                          children: "Housing Levy",
                        }),
                        g.jsxs("span", {
                          className:
                            "font-semibold text-gray-800 dark:text-gray-200",
                          children: [
                            (
                              ((n == null ? void 0 : n.housingLevyRate) ??
                                t.payrollConfig.housingLevyRate) * 100
                            ).toFixed(1),
                            "%",
                          ],
                        }),
                    ...
                    children: [
                      ...
                      g.jsxs("span", {
                        ...
                        children: [
                          ...
                          " ",
                          (n
                            ? n.exciseDutyPerLiter
                            : t.revenueAuthority.exciseDuty
                          ).toFixed(2),
                        ],
                      }),
                    ],
                    ...
                    children: [
                      ...
                      g.jsxs("span", {
                        ...
                        children: [
                          f,
                          " ",
                          (n || t.payrollConfig).minimumWage.toLocaleString(),
                        ],
                      }),
                    ],
                  }),
              ...
              g.jsx("p", {
                className: "text-[9px] text-gray-400 mt-3 text-right",
                children: n
                  ? `Last updated: ${new Date(n.lastUpdated).toLocaleDateString()}`
          ...
          g.jsx("div", {
            className:
              "bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-700 shadow-sm",
            children: g.jsx(Zo, { countryCode: t.currentCountry.id }),
          }),
        ],
      }),
      g.jsxs("div", {
        ...
        children: [
          g.jsxs("div", {
            className:
              "lg:col-span-2 bg-white dark:bg-gray-800 rounded-xl p-5 shadow-sm border border-gray-200 dark:border-gray-700",
            children: [
              g.jsxs("div", {
                className: "flex items-center justify-between mb-4",
                children: [
                  g.jsxs("h3", {
                    ...
                    children: [
                      g.jsx(qs, { size: 18, className: "text-blue-500" }),
                      "Sales Trend (Last 7 Days)",
                    ],
                  }),
                  g.jsx("span", {
                    className:
                      "text-xs text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded",
                    children: "Ksh",
                  }),
                ],
              }),
              g.jsx("div", {
                className: "h-64",
                children: g.jsx(Eh, { data: M, options: C }),
              }),
            ],
          }),
          g.jsxs("div", {
            ...
            children: [
              g.jsxs("h3", {
                ...
                children: [
                  g.jsx(ys, { size: 18, className: "text-green-500" }),
                  "Fuel Distribution",
                ],
              }),
              g.jsx("div", {
                className: "h-48",
                children: g.jsx(Hh, { data: w, options: N }),
              }),
              g.jsxs("div", {
                className: "mt-4 grid grid-cols-2 gap-2 text-center",
                children: [
                  g.jsxs("div", {
                    className: `rounded-lg p-2 ${i ? "bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800" : "bg-gray-50 dark:bg-gray-700/30"}`,
                    children: [
                      g.jsx("p", {
                        className: "text-xs text-gray-500 dark:text-gray-400",
                        children: "PMS Price",
                      ...
                      i &&
                        g.jsxs("p", {
                          className:
                            "text-[9px] text-green-600 dark:text-green-400 mt-0.5 flex items-center justify-center gap-0.5",
                          children: [g.jsx(ss, { size: 8 }), " Auto-synced"],
                        }),
                    ],
                  }),
                  g.jsxs("div", {
                    className: `rounded-lg p-2 ${i ? "bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800" : "bg-gray-50 dark:bg-gray-700/30"}`,
                    children: [
                      g.jsx("p", {
                        className: "text-xs text-gray-500 dark:text-gray-400",
                        children: "AGO Price",
                      ...
                      i &&
                        g.jsxs("p", {
                          className:
                            "text-[9px] text-amber-600 dark:text-amber-400 mt-0.5 flex items-center justify-center gap-0.5",
                          children: [g.jsx(ss, { size: 8 }), " Auto-synced"],
                        }),
                    ],
                  }),
            ...
            children: [
              g.jsxs("h3", {
                className:
                  "text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2",
                children: [
                  g.jsx(is, { size: 18, className: "text-rose-500" }),
                  "Expense Breakdown",
                ],
              }),
              g.jsx("div", {
                className: "h-48",
                children: g.jsx(Bh, { data: S, options: O }),
              }),
            ],
          }),
          g.jsxs("div", {
            ...
            children: [
              g.jsxs("h3", {
                className:
                  "text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2",
                children: [
                  g.jsx(Js, { size: 18, className: "text-blue-500" }),
                  "Quick Actions",
                ],
              }),
              g.jsx("div", {
                ...
                children: L.map(A =>
                  g.jsxs(
                    ...
                    {
                      onClick: () => K(A.tab),
                      className: `${A.color} text-white rounded-xl p-4 text-left transition-all hover:scale-[1.02] active:scale-[0.98] shadow-sm`,
                      children: [
                        g.jsx(A.icon, {
                          size: 24,
        ...
        children: [
          g.jsxs("h3", {
            className:
              "text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2",
            children: [
              g.jsx(Te, { size: 18, className: "text-blue-500" }),
              "Tank Levels",
            ],
          }),
          g.jsxs("div", {
              ...
              g.jsxs("div", {
                children: [
                  g.jsxs("div", {
                    ...
                    children: [
                      ...
                      g.jsxs("span", {
                        className: "text-xs text-gray-500 dark:text-gray-400",
                        children: [
                          ct(s.pmsTankClosing - s.pmsTankOpening, 0),
                          " L dispensed",
                        ],
                      }),
                    ],
                  ...
                  g.jsx("div", {
                    ...
                    children: g.jsx("div", {
                      className:
                        "h-full bg-gradient-to-r from-green-400 to-green-600 rounded-full transition-all duration-500",
                      style: {
                        width: `${Math.min(100, s.pmsTankClosing > 0 ? (s.pmsTankClosing / (s.pmsTankClosing + 5e3)) * 100 : 0)}%`,
                      },
                    }),
                  }),
                  g.jsxs("div", {
                    className:
                      "flex justify-between mt-1 text-xs text-gray-500 dark:text-gray-400",
                    children: [
                      g.jsxs("span", {
                        children: ["Opening: ", ct(s.pmsTankOpening), " L"],
                      }),
                      g.jsxs("span", {
                        children: ["Closing: ", ct(s.pmsTankClosing), " L"],
                      }),
                    ],
                  }),
                ],
              ...
              g.jsxs("div", {
                children: [
                  g.jsxs("div", {
                    ...
                    children: [
                      ...
                      g.jsxs("span", {
                        className: "text-xs text-gray-500 dark:text-gray-400",
                        children: [
                          ct(s.agoTankClosing - s.agoTankOpening, 0),
                          " L dispensed",
                        ],
                      }),
                    ],
                  ...
                  g.jsx("div", {
                    ...
                    children: g.jsx("div", {
                      className:
                        "h-full bg-gradient-to-r from-amber-400 to-amber-600 rounded-full transition-all duration-500",
                      style: {
                        width: `${Math.min(100, s.agoTankClosing > 0 ? (s.agoTankClosing / (s.agoTankClosing + 5e3)) * 100 : 0)}%`,
                      },
                    }),
                  }),
                  g.jsxs("div", {
                    ...
                    children: [
                      g.jsxs("span", {
                        children: ["Opening: ", ct(s.agoTankOpening), " L"],
                      }),
                      g.jsxs("span", {
                        children: ["Closing: ", ct(s.agoTankClosing), " L"],
                      }),
                    ],
                  }),
                ],
        ...
        children: [
          g.jsxs("h3", {
            className:
              "text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2",
            children: [
              g.jsx(is, { size: 18, className: "text-purple-500" }),
              "Pump Status",
            ],
          }),
          g.jsxs("div", {
            ...
            children: [
              g.jsxs("div", {
                className:
                  "text-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg",
                children: [
                  g.jsx("p", {
                    className:
                      "text-2xl font-bold text-green-700 dark:text-green-300",
                    children: s.pmsPumps.length,
                  }),
                  g.jsx("p", {
                    className: "text-xs text-gray-500 dark:text-gray-400",
                    children: "PMS Pumps",
              ...
              g.jsxs("div", {
                className:
                  "text-center p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg",
                children: [
                  g.jsx("p", {
                    className:
                      "text-2xl font-bold text-amber-700 dark:text-amber-300",
                    children: s.agoPumps.length,
                  }),
                  g.jsx("p", {
                    className: "text-xs text-gray-500 dark:text-gray-400",
                    children: "AGO Pumps",
              ...
              g.jsxs("div", {
                className:
                  "text-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg",
                children: [
                  g.jsx("p", {
                    className:
                      "text-2xl font-bold text-blue-700 dark:text-blue-300",
                    children: Object.keys(s.invoices).length,
                  }),
                  g.jsx("p", {
                    className: "text-xs text-gray-500 dark:text-gray-400",
                    children: "Invoices",
              ...
              g.jsxs("div", {
                className:
                  "text-center p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg",
                children: [
                  g.jsx("p", {
                    className:
                      "text-2xl font-bold text-purple-700 dark:text-purple-300",
                    children: s.employees.length,
                  }),
                  g.jsx("p", {
                    className: "text-xs text-gray-500 dark:text-gray-400",
                    children: "Employees",
