...
import { FileUp, FileType, AlertCircle, CheckCircle2, X, Loader2, Download, FileText,
    ...
    case 'pdf': {
      ...
      try {
        ...
        for (let i = 1; i <= pageCount; i++) {
          ...
          doc.text(`Generated by FuelPro Document Converter    Page ${i} of ${pageCount}`, margin, (doc.internal as any).pageSize.getHeight() - 10);
        }
