...
import { Download, FileText, Table, MessageSquare, Mail, FileSpreadsheet } from 'lucide-react';
...
const FORMATS = [
  ...
  { key: 'excel' as const, label: 'Excel', icon: FileSpreadsheet, color: 'text-green-500' },
  { key: 'txt' as const, label: 'Text', icon: FileText, color: 'text-gray-500' },
  { key: 'whatsapp' as const, label: 'WhatsApp', icon: MessageSquare, color: 'text-green-600' },
