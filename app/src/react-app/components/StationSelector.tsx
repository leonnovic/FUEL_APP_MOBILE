...
import { Building2, ChevronDown, Plus, MapPin, Edit2, Trash2, Check, X } from 'lucide-react';
...
export default function StationSelector({ compact = false }: StationSelectorProps) {
  ...
  const handleDeleteStation = (stationId: string) => {
    ...
    if (confirm('Are you sure you want to delete this station? All data for this station will be lost.')) {
  ...
  return (
    <div className="relative inline-block">
      ...
      >
        <Building2 size={compact ? 14 : 16} className="text-amber-600 dark:text-amber-400 flex-shrink-0" />
        {!compact && (
