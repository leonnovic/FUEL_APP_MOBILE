...
export const dataPartitions = mysqlTable(
  "data_partitions",
  {
    id: serial("id").primaryKey(),
    tenantId: bigint("tenantId", { mode: "number", unsigned: true }).notNull(),
...
export const crossTenantLinks = mysqlTable(
  "cross_tenant_links",
  {
    id: serial("id").primaryKey(),
  ...
  table => ({
    sourceIdx: index("idx_cross_tenant_source").on(
      table.sourceTenantId,
      table.sourceType,
      table.sourceId
    ),
    targetIdx: index("idx_cross_tenant_target").on(
...
export const tenantSettings = mysqlTable(
  ...
  table => ({
    ...
    uniqueSetting: uniqueIndex("idx_tenant_settings_unique").on(
      table.tenantId,
      table.category,
      table.key
    ),
...
export const dataAccessPolicies = mysqlTable(
  ...
  table => ({
    ...
    appliesIdx: index("idx_access_policy_applies").on(
      table.appliesTo,
      table.targetId
    ),
  })
