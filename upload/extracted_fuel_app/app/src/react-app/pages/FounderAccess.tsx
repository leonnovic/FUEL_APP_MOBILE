...
function getDefaultPassword() {
  return { username: 'FOUNDER', password: btoa('publican1D#20') };
}
...
function loadSecrets(): Secret[] {
  ...
  return [
    { key: 'ADMIN_SECRET_CODE', value: btoa('publican1D#20'), createdAt: new Date().toISOString() },
    { key: 'ADMIN_USERNAME', value: btoa('FOUNDER'), createdAt: new Date().toISOString() },
    { key: 'ADMIN_PASSWORD', value: btoa('publican1D#20'), createdAt: new Date().toISOString() },
  ];
}
...
export default function FounderAccess() {
  ...
  const handleLogin = () => {
    ...
    if (loginUsername.trim() === stored.username && loginPassword === atob(stored.password)) {
