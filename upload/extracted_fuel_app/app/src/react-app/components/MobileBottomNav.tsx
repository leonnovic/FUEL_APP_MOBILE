import { Home, ShoppingCart, BarChart3, FileText, MoreHorizontal, Fuel, Truck, CreditCard, Users, FolderOpen, Newspaper, Database, Activity, TrendingUp, Bell, Package, Award, Calendar, FlaskConical, Wallet, LineChart, ClipboardList, Plug, Globe } from 'lucide-react';
...
export default function MobileBottomNav({ activeTab, onTabChange }: MobileBottomNavProps) {
  ...
  // Primary nav items (always visible) - filtered by role
  ...
  // Secondary nav items (in "More" menu) - filtered by role
  const secondaryNav: NavItem[] = [
    ...
    { id: 'customers', label: 'Customers', icon: Award, color: 'text-amber-500' },
    ...
    { id: 'communication', label: 'Comm', icon: Activity, color: 'text-green-500' },
    { id: 'news', label: 'News', icon: Newspaper, color: 'text-blue-400' },
    { id: 'data', label: 'Data Mgr', icon: Database, color: 'text-gray-400' },
    { id: 'integration', label: 'Connect', icon: Plug, color: 'text-indigo-500' },
    { id: 'regional', label: 'Regional', icon: Globe, color: 'text-blue-500' },
  ...
  // If no secondary nav items, hide the More button
