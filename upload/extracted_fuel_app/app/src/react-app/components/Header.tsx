        ...
        <div className="bg-white/5 border-t border-white/10 px-4 py-4">
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
              <input value={editData.name} onChange={e => setEditData(p => ({ ...p, name: e.target.value }))} placeholder="Company Name" className="px-3 py-2 rounded-lg bg-white/10 border border-white/20 text-white placeholder-gray-500 text-sm focus:outline-none focus:ring-1 focus:ring-amber-400" />
              <input value={editData.vatRegNo} onChange={e => setEditData(p => ({ ...p, vatRegNo: e.target.value }))} placeholder="VAT Number" className="px-3 py-2 rounded-lg bg-white/10 border border-white/20 text-white placeholder-gray-500 text-sm focus:outline-none focus:ring-1 focus:ring-amber-400" />
              <input value={editData.kraPin} onChange={e => setEditData(p => ({ ...p, kraPin: e.target.value }))} placeholder="KRA PIN" className="px-3 py-2 rounded-lg bg-white/10 border border-white/20 text-white placeholder-gray-500 text-sm focus:outline-none focus:ring-1 focus:ring-amber-400" />
              <input value={editData.contacts} onChange={e => setEditData(p => ({ ...p, contacts: e.target.value }))} placeholder="Phone" className="px-3 py-2 rounded-lg bg-white/10 border border-white/20 text-white placeholder-gray-500 text-sm focus:outline-none focus:ring-1 focus:ring-amber-400" />
              <button onClick={handleEditInfo} className="px-4 py-2 bg-amber-500 hover:bg-amber-600 text-white text-sm font-semibold rounded-lg transition-colors flex items-center justify-center gap-2"><Check size={14} /> Save</button>
            </div>
          </div>
        </div>
      )}
