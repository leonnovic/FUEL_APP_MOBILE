...
export default function SetupWizard({ onComplete }: SetupWizardProps) {
  ...
  const [data, setData] = useState<WizardData>({
    ...
    pmsCount: 2,
    agoCount: 2,
    pmsPrice: 204.35,  // EPRA Lodwar Super Petrol price
    agoPrice: 203.72,  // EPRA Lodwar Diesel price
    kraPin: '',
    vatRegNo: '',
    physicalAddress: 'Lodwar Town, Turkana County, Kenya',
    etrSerialNo: '',
  });
  ...
  const handleComplete = () => {
    ...
    try {
      const newStation = createStation({
        ...
        location: data.location || 'Lodwar, Turkana County',
    ...
    localStorage.setItem(`fuelpro_station_${newStationId || 'default'}_location`, data.location || 'Lodwar, Turkana County');
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl p-5 border border-green-200 dark:border-green-800">
          ...
          <div className="relative">
            <span className="absolute left-3 top-1/2 -translate-y-1/2 text-lg font-semibold text-green-600">KES</span>
            <input
              type="number"
              value={data.pmsPrice}
        ...
        <div className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-xl p-5 border border-amber-200 dark:border-amber-800">
          ...
          <div className="relative">
            <span className="absolute left-3 top-1/2 -translate-y-1/2 text-lg font-semibold text-amber-600">KES</span>
            <input
              type="number"
              value={data.agoPrice}
